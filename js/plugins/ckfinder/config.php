 ...
 */
$servermethod = (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] != 'off') ? 'https://' . $_SERVER['SERVER_NAME'] : 'http://' . $_SERVER['SERVER_NAME'];
$_baseUrl = '/data/media/' . $_SESSION['site_id'] . '/' .$_SESSION['public-user-session'].'/';
$baseUrl = $servermethod . $_baseUrl;
/*
...
$config['ResourceType'][] = Array(
    ...
    'deniedExtensions' => '');
if (!is_dir($baseDir . 'images/' . date('Y'))) {
    $config['ResourceType'][] = Array(
        'name' => 'Images',
