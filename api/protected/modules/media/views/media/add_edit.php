            ...
            <div class="row">
                <div class="col-xs-12 no-padding">
                    ...
                    <div class="control-group form-group">
                        ...
                        <div class="controls col-sm-10">
                            <?php echo $form->dropDownList($model, 'status', Constant::statusPrintImageArray(), array('class' => 'form-control w3-form-input')); ?>
                    ...
                    <div class="control-group form-group">
                        ...
                        <div class="controls col-sm-10">
                            <?php echo $form->dropDownList($model, 'payment_method', Constant::statusPaymentMethod(), array('class' => 'form-control w3-form-input')); ?>
                    ...
                    <div class="control-group form-group">
                        ...
                        <div class="controls col-sm-10">
                            <?php echo $form->dropDownList($model, 'payment_status', Constant::statusPayment(), array('class' => 'form-control w3-form-input')); ?>
                    ...
                    <div class="control-group form-group">
                        ...
                        <div class="controls col-sm-10">
                            <?php echo $form->dropDownList($model, 'transport_method', Constant::transportMethod(), array('class' => 'form-control w3-form-input')); ?>
