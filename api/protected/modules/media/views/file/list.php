...
<div class="widget-box">
    <div class="widget-header">
        ...
        <div class="widget-toolbar no-border">
            <a href="<?php echo Yii::app()->createUrl('media/folder'); ?>" class="btn btn-xs btn-success" style="margin-right: 20px;">
                <i class="icon-plus"></i>
                <?php echo Yii::t('file', 'folder_manager'); ?>
            </a>
            <a href="<?php echo Yii::app()->createUrl('media/file/create'); ?>" class="btn btn-xs btn-primary" style="margin-right: 20px;">
                <i class="icon-plus"></i>
                <?php echo Yii::t('file', 'file_create'); ?>
            </a>
            <a href="<?php echo Yii::app()->createUrl('media/file/deleteall'); ?>" class="btn btn-xs btn-danger delAllinGrid" grid="file-grid">
