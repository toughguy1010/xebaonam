<div class="item alimgitem <?php echo ($image['img_id'] == $avatar_id) ? 'active' : '' ?>">
    <div class="alimgitembox">
        <div class="delimg">
            <a href="<?php echo Yii::app()->createUrl('/media/album/delimage', array('iid' => $image['img_id'])); ?>" class="delimgaction"><i class="icon-remove"></i></a>
        </div>
        <div class="alimgthum">
        ...
        <div class="alimgaction" style="text-align: left;">
            ...
            <br />
            <input <?php echo $image['ishot'] ? 'checked' : '' ?> type="checkbox" name="ImageHot[<?php echo $image['img_id'] ?>]" value="1" /> <span> Hot</span>
        </div>
        <div class="imgAlt">
