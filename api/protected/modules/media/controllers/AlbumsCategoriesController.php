...
class AlbumsCategoriesController extends ApiController {
    ...
    public function actionCreate($id) {
        ...
        if (Yii::app()->request->isPostRequest && $post) {
            ...
            $model->showinhome = (isset($post["showinhome"]) && $post["showinhome"]) ? Constant::STATUS_ACTIVED : Constant::STATUS_DEACTIVED;
