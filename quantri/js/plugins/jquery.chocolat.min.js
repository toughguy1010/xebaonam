...
$('[data-gallery="chocolat"]').Chocolat({overlayColor:'#000',leftImg:'img/chocolat/leftw.gif',rightImg:'img/chocolat/rightw.gif',closeImg:'img/chocolat/closew.gif',loadingImg:'img/chocolat/loading.gif'});