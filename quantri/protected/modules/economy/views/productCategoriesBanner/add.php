            ...
            <div class="row">
                <div class="col-xs-12 no-padding">
                    ...
                    <div class="control-group form-group">
                        ...
                        <div class="controls col-sm-10">
                            <?php echo $form->dropDownList($model, 'category_id', $option_category, array('class' => 'span2 col-sm-4')); ?>
                    ...
                    <div class="control-group form-group">
                        ...
                        <div class="controls col-sm-10">
                            <?php echo $form->dropDownList($model, 'position', ProductCategoriesBanner::arrPosition(), array('class' => 'span10 col-sm-12')); ?>
