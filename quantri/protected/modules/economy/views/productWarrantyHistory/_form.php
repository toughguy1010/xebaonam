        ...
        <div class="tabbable">
            ...
            <div class="tab-content">
                <div id="basicinfo" class="tab-pane active">
                    <?php
                    $this->renderPartial('partial/tabbasicinfo', array('model' => $model, 'form' => $form, 'option_product' => $option_product));
                    ?>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    $('#ProductWarrantyHistory_product_warranty_id').on('change', function (e) {
        // triggers when whole value changed
        $('#ProductWarrantyHistory_product_name').val($("form .chosen-single span").text());
    });
</script>