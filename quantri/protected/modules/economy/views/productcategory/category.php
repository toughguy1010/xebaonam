    ...
    <div class="widget-header">
        ...
        <div class="widget-toolbar no-border">
            <?php if (ClaUser::isSupperAdmin()) { ?>
                <a href="<?php echo Yii::app()->createUrl('economy/productcategory/importExcel'); ?>" class="btn btn-xs btn-primary" style="margin-right: 20px;">
                    <i class="icon-plus"></i>
                    <?php echo Yii::t('category', 'category_import_excel'); ?>
                </a>
            <?php } ?>
            ...
            $this->widget('zii.widgets.grid.CGridView', array(
                ...
                'columns' => array(
                    ...
                    'cat_order' => array(
                        ...
                        'type' => 'raw',
                        'value' => function($data) {
                            return CHtml::textField('cat_order', $data['cat_order'], array('class' => 'updateorder', 'style' => 'width: 50px;', 'rel' => Yii::app()->createUrl('economy/productcategory/updateorder', array('id' => $data['cat_id'],))));
                        },
                            ...
                            'add_child' => array(
                                ...
                                'type' => 'raw',
                                'value' => function($data) {
                                    return '<a class="icon-folder-open" style="font-size: 18px; position: relative;" href="' . Yii::app()->createUrl('economy/productcategory/addcat', array('pa' => $data['cat_id'])) . '"><i class="icon-plus" style="font-size: 13px; position: absolute; top:-2px; left: -4px; color: #fe8100;"></i>' . '</a>';
                                },
                                    ...
                                    array(
                                        ...
                                        'buttons' => array(
                                            ...
                                            'update' => array(
                                                'label' => '',
                                                'imageUrl' => false,
                                                'url' => 'Yii::app()->createUrl("economy/productcategory/editcat", array("id" => $data["cat_id"]))',
                                                'options' => array('class' => 'icon-edit', 'title' => Yii::t('common', 'update')),
                                            ),
                                            'delete' => array(
                                                'label' => '',
                                                'imageUrl' => false,
                                                'url' => 'Yii::app()->createUrl("economy/productcategory/delcat", array("id" => $data["cat_id"]))',
                                    ...
                                    'translate' => array(
                                        ...
                                        'value' => function($data) {
                                    $this->widget('application.widgets.translate.translate', array('baseUrl' => '/economy/productcategory/editcat', 'params' => array('id' => $data['cat_id']), 'model' => ProductCategories::model()->findByPk($data['cat_id'])));
                                }
                                    ),
                                ),
                            ));
