...
<?php } else { ?>
    ...
    <a id="addVideos"
       href="<?php echo Yii::app()->createUrl('economy/event/addVideoToRelation', array('pid' => $model->id)) ?>"
    ...
    $this->widget('zii.widgets.grid.CGridView', array(
        ...
        'columns' => array(
            ...
            array(
                ...
                'deleteButtonLabel' => '',
                'deleteButtonUrl' => 'Yii::app()->createUrl("/economy/event/deleteVideoInRel",array("event_id"=>$data["event_id"],"video_id"=>$data["video_id"]))',
            ),
        ),
    ));
    ?>
