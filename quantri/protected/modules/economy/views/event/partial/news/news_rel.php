...
<?php } else { ?>
    ...
    <a id="addNews"
       href="<?php echo Yii::app()->createUrl('economy/event/addnewstorelation', array('pid' => $model->id)) ?>"
       class="btn btn-sm btn-primary">
        <?php echo Yii::t('event', 'add_news'); ?>
    </a>
    <?php
    ...
    $this->widget('zii.widgets.grid.CGridView', array(
        ...
        'columns' => array(
            ...
            array(
                ...
                'deleteButtonLabel' => '',
                'deleteButtonUrl' => 'Yii::app()->createUrl("/economy/event/deleteNewsInRel",array("event_id"=>$data["event_id"],"news_id"=>$data["news_id"]))',
            ),
        ),
    ));
    ?>
