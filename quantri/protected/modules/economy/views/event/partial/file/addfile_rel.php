                            ...
                            <div class="col-sm-7">
                                <div class="widget-box" id="searchproduct">
                                    <div class="widget-header header-color-grey">
                                        <h4 class="lighter smaller"><?php echo Yii::t('files', 'files'); ?></h4>
                                    </div>
                                    <div class="widget-body">
                                        <div class="widget-main padding-8">
                                            <div class="search-active-form"
                                                ...
                                                <?php
                                                $this->renderPartial('partial/file/_searchfile', array(
                                                    'fileModel' => $fileModel,
                                                ));
                                                ?>
                                            </div><!-- search-form -->
                            ...
                            <div class="col-sm-5" id="choicedproduct">
                                ...
                                <div class="widget-box">
                                    <div class="widget-header header-color-green2">
                                        <h4 class="lighter smaller"><?php echo Yii::t('file', 'choiced_file') ?></h4>
                                        <div class="widget-toolbar no-border">
                                            <?php echo CHtml::submitButton(Yii::t('file', 'choiced_file_save'), array('class' => 'btn btn-xs btn-primary', 'id' => 'btnProductSave')); ?>
                                        </div>
                                            ...
                                            <table class="table table-bordered table-hover vertical-center products">
                                                ...
                                                <tr>
                                                    <th id="products-grid_c0">
                                                        <?php echo $fileModel->getAttributeLabel('file_title'); ?>
                                                    </th>
                                ...
                                <?php
                                echo CHtml::hiddenField('rel_file', $file_ids, array('id' => 'choicedProducts'));
                                ?>
                                <?php
                                $this->endWidget();
                                ?>
...
<?php
$this->renderPartial('partial/file/script', array('isAjax' => $isAjax, 'model_info_file' => $file_ids)); ?>