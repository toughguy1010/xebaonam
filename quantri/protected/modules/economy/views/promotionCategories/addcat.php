...
<div class="widget widget-box">
    <div class="widget-header"><h4>
            <?php echo Yii::app()->controller->action->id != "update" ? Yii::t('category', 'category_event_create') : Yii::t('category', 'category_event_update'); ?>
        </h4></div>
                ...
                <div class="col-xs-12 no-padding">
                    ...
                    <div class="control-group form-group">
                        ...
                        <div class="controls col-sm-10">
                            ...
                            <div id="promotioncategoryavatar" style="display: block; margin-top: 0px;">
                                <div id="promotioncategoryavatar_img" style="display: inline-block; max-width: 100px; max-height: 100px; overflow: hidden; vertical-align: top; <?php if ($model->avatar) echo 'margin-right: 10px;'; ?>">
                                ...
                                <div id="promotioncategoryavatar_form" style="display: inline-block;">
...
<script type="text/javascript">
    jQuery(function ($) {
        jQuery('#promotioncategoryavatar_form').ajaxUpload({
            url: '<?php echo Yii::app()->createUrl("/economy/promotionCategories/uploadfile"); ?>',
            name: 'file',
            onSubmit: function () {
            },
            onComplete: function (result) {
                ...
                if (obj.status == '200') {
                    if (obj.data.realurl) {
                        jQuery('#PromotionCategories_avatar').val(obj.data.avatar);
                        if (jQuery('#promotioncategoryavatar_img img').attr('src')) {
                            jQuery('#eventcategoryvatar_img img').attr('src', obj.data.realurl);
                        } else {
                            jQuery('#promotioncategoryavatar_img').append('<img src="' + obj.data.realurl + '" />');
                        }
                        jQuery('#promotioncategoryavatar_img').css({"margin-right": "10px"});
                    }
                }
            }
        });
