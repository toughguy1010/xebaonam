...
<div class="widget widget-box">
    <div class="widget-header"><h4>
            <?php echo Yii::app()->controller->action->id != "update" ? Yii::t('course', 'consultant_add_new') : Yii::t('course', 'consultant_update'); ?>
        </h4></div>
        ...
        <div class="widget-main">
            <div class="row">
                <div class="col-xs-12 no-padding">
                    ...
                    <div class="control-group form-group">
                        ...
                        <div class="controls col-sm-10">
                            ...
                            $this->widget('common.extensions.EJuiDateTimePicker.EJuiDateTimePicker', array(
                                ...
                                'name' => 'Consultant[bod]', //attribute name
                    ...
                    <div class="control-group form-group">
                        <?php echo $form->labelEx($model, 'background', array('class' => 'col-sm-2 control-label no-padding-left')); ?>
                        <div class="controls col-sm-10">
                            <?php echo $form->hiddenField($model, 'background', array('class' => 'span12 col-sm-12')); ?>
                            <div id="consultantbackground" style="display: block; margin-top: 0px;">
                                <div id="consultantbackground_img"
                                     style="display: inline-block; max-width: 100px; max-height: 100px; overflow: hidden; vertical-align: top; <?php if ($model->background) echo 'margin-right: 10px;'; ?>">
                                    <?php if ($model->background_path && $model->background_name) { ?>
                                        <img
                                            src="<?php echo ClaHost::getImageHost() . $model->background_path . 's100_100/' . $model->background_name; ?>"
                                            style="width: 100%;"/>
                                    <?php } ?>
                                </div>
                                <div id="consultantbackground_form" style="display: inline-block;">
                                    <?php echo CHtml::button(Yii::t('setting', 'btn_select_background'), array('class' => 'btn  btn-sm')); ?>
                                </div>
                            </div>
                    ...
                    <div class="control-group form-group">
                        ...
                        <div class="controls col-sm-10">
                            ...
                            <div id="consultantavatar" style="display: block; margin-top: 0px;">
                                <div id="consultantavatar_img"
                                ...
                                <div id="consultantavatar_form" style="display: inline-block;">
                    ...
                    <div class="control-group form-group">
                        ...
                        <div class="controls col-sm-10">
                            ...
                            <label class="col-sm-2 control-label no-padding-left"><i>&nbsp; (năm kinh
                                    nghiệm)</i></label>
...
<!--                    <div class="control-group form-group">-->
<!--                        --><?php //echo $form->labelEx($model, 'is_boss', array('class' => 'col-sm-2 control-label no-padding-left')); ?>
<!--                        --><?php //echo $form->checkBox($model, 'is_boss'); ?>
<!--                        --><?php //echo $form->error($model, 'is_boss'); ?>
<!--                    </div>-->
                    <div class="control-group form-group">
...
<script type="text/javascript">
    jQuery(function ($) {
        jQuery('#consultantbackground_form').ajaxUpload({
            url: '<?php echo Yii::app()->createUrl("/economy/consultant/UploadBgfile"); ?>',
            name: 'file',
            onSubmit: function () {
            },
            onComplete: function (result) {
                ...
                if (obj.status == '200') {
                    if (obj.data.realurl) {
                        jQuery('#Consultant_background').val(obj.data.background);
                        if (jQuery('#consultantbackground_img img').attr('src')) {
                            jQuery('#consultantbackground_img img').attr('src', obj.data.realurl);
                        } else {
                            jQuery('#consultantbackground_img').append('<img src="' + obj.data.realurl + '" />');
                        }
                        jQuery('#consultantbackground_img').css({"margin-right": "10px"});
                    }
                }
            }
        });
        ...
        jQuery('#consultantavatar_form').ajaxUpload({
            url: '<?php echo Yii::app()->createUrl("/economy/consultant/uploadfile"); ?>',
            name: 'file',
            onSubmit: function () {
            },
            onComplete: function (result) {
                ...
                if (obj.status == '200') {
                    if (obj.data.realurl) {
                        jQuery('#Consultant_avatar').val(obj.data.avatar);
                        if (jQuery('#consultantavatar_img img').attr('src')) {
                            jQuery('#consultantavatar_img img').attr('src', obj.data.realurl);
                        } else {
                            jQuery('#consultantavatar_img').append('<img src="' + obj.data.realurl + '" />');
                        }
                        jQuery('#consultantavatar_img').css({"margin-right": "10px"});
                    }
                }
            }
        });
