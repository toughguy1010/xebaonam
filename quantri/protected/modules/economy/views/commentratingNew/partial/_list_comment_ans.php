...
//                    'rating',
                ...
                array(
                    ...
                    (
                        'delete' => array
                        (
                            'url' => 'Yii::app()->createUrl("/economy/commentratingNew/deleteans", array("id"=>$data->id))',
...
//                            'imageUrl' => '',
                            'url' => 'Yii::app()->createUrl("/economy/commentratingNew/showans", array("id"=>$data->id))',
...
//                            'icon' => 'icon-eye',
                            'visible' => '($data->status != ActiveRecord::STATUS_DEACTIVED) ? true : false',
//                            'imageUrl' => '',
                            'url' => 'Yii::app()->createUrl("/economy/commentratingNew/hideans", array("id"=>$data->id))',
