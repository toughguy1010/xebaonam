        ...
        <div class="widget-main">
            <div class="row">
                <div class="col-xs-12 no-padding">
                    ...
                    <div class="control-group form-group">
                        <?php echo $form->labelEx($model, 'course_id', array('class' => 'col-xs-2 control-label no-padding-left')); ?>
                        <div class="controls col-sm-10">
                            <?php echo $form->dropDownList($model, 'course_id', $option_course, array('class' => 'form-control w3-form-input')); ?>
