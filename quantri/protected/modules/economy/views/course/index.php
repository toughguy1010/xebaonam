...
<div class="widget-box">
    <div class="widget-header">
        ...
        <div class="widget-toolbar no-border">
            <a href="<?php echo Yii::app()->createUrl('economy/courseCategories'); ?>" class="btn btn-xs btn-success"
               style="margin-right: 20px;">
                <i class="icon-cogs"></i>
                <?php echo Yii::t('course', 'course_category'); ?>
            </a>
            <a href="<?php echo Yii::app()->createUrl('economy/course/create'); ?>" class="btn btn-xs btn-primary"
               style="margin-right: 20px;">
                <i class="icon-plus"></i>
...
//                        'name' => 'price_member',
//                        'value' => function($data) {
//                            if ($data->price_member)
//                                return HtmlFormat::money_format($data->price_member);
//                            return '';
//                        }
//                    ),
                    'status' => array(
                    ...
                    array(
                        'class' => 'CButtonColumn',
                        'template' => '{update}  {delete} {_preview}',
                        'viewButtonLabel' => '',
                            ...
                            '_preview' => array(
                                ...
                                'url' => function ($data) {
                                    ...
                                    $respon = $api->createUrl(array(
                                        'basepath' => '/economy/course/detail',
                                ...
                                'options' => array('style' => 'padding: 0px 10px;font-size: 17px;', 'class' => 'icon-search', 'title' => 'Preview', 'target' => '_blank'),
                            ),
                        ),
                    ),
                    'translate' => array(
