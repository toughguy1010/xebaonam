            ...
            $this->widget('zii.widgets.grid.CGridView', array(
                ...
                'columns' => array(
                    ...
                    'course_id' => array(
                        'name' => 'course_id',
                        'value' => function ($data) {
                            return Yii::app()->controller->getCourseName($data->course_id);
                        }
                    ),
                    'message',
                    'created_time' => array(
                    ...
                    array(
                        ...
                        'buttons' => array(
                            'update' => array(
                                'url' => 'Yii::app()->createUrl("economy/course/updateCourseRegiter", array("id" => $data->id))',
                            ),
                            'delete' => array(
                                'url' => 'Yii::app()->createUrl("economy/course/deleteCourseRegister", array("id" => $data->id))',
                            ),
                        ),
                    ),
                    'translate' => array(
