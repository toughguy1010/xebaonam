<?php if ($model->isNewRecord) { ?>
    <a id="addProduct" href="javascript:void(0);" class="btn btn-sm btn-light"
       onclick="alert('<?php echo Yii::t('product', 'promotion_addproduct_disable_help'); ?>');">
        <?php echo Yii::t('product', 'promotion_addproduct'); ?>
    </a>
<?php } else { ?>
    ...
    <a id="addProduct"
       href="<?php echo Yii::app()->createUrl('economy/promotion/addproduct', array('pid' => $model->promotion_id)) ?>"
    ...
    $this->widget('zii.widgets.grid.CGridView', array(
        ...
        'columns' => array(
            ...
            array(
                ...
                'deleteButtonLabel' => '',
                'deleteButtonUrl' => 'Yii::app()->createUrl("/economy/promotion/deleteproduct",array("id"=>$data["id"]))',
            ),
        ),
    ));
    ?>
    <script>
        function update(e, item_id) {
            ...
            var url = "<?php echo Yii::app()->createUrl("/economy/promotion/updateOrder", array("id" => $model->promotion_id));?>";
            $.ajax({
                url: url,
                dataType: "json",
