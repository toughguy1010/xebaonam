        ...
        <div class="tabbable">
            <ul class="nav nav-tabs padding-12" id="myTab">
                <li class="<?php if (!$from_create) echo 'active' ?>">
                    <a data-toggle="tab" href="#basicinfo">
                        <?php echo Yii::t('product', 'promotion_basicinfo'); ?>
                    </a>
                </li>
                <li class="<?php if ($from_create) echo 'active' ?>">
                    <a data-toggle="tab" href="#products">
                        <?php echo Yii::t('product', 'promotion_products'); ?>
                    </a>
                </li>
            </ul>
            ...
            <div class="tab-content">
                <div id="basicinfo" class="tab-pane <?php if (!$from_create) echo 'active' ?>">
                    <?php
                    $this->renderPartial('partial/tabbasicinfo', array('model' => $model, 'form' => $form, 'option_category' => $option_category));
                    ?>
                </div>
