...
?>
    <?php echo $form->textField($model, 'billing_name', array('class' => '', 'placeholder' =>  Yii::t('shoppingcart', 'customer')));
$this->widget('common.extensions.EJuiDateTimePicker.EJuiDateTimePicker', array(
    'model'       => $model, //Model object
    'name'        => 'Orders[from_date]', //attribute name
    'mode'        => 'date',
...
$this->widget('common.extensions.EJuiDateTimePicker.EJuiDateTimePicker', array(
    'model'       => $model, //Model object
    'name'        => 'Orders[to_date]', //attribute name
    'mode'        => 'date',
