            ...
            $this->widget('zii.widgets.grid.CGridView', array(
                ...
                'columns' => array(
                    ...
                    'Sửa lại báo giá' => array(
                        ...
                        'value' => function ($data)  {
                            return ($data->order_status == Orders::ORDER_WAITFORPROCESS) ? '<a class="icon-edit" href="'.Yii::app()->createUrl('/economy/order/edit',array('id' => $data->order_id)).'></a>' : '';
                        }
                    ),
                    'note' => array(
                        'name' => 'note',
                        'visible' => (Yii::app()->controller->site_id == 2071) ? true : false,
                        'type' => 'raw',
                        'value' => '$data->note',
