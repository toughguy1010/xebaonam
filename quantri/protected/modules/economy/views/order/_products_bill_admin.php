    ...
    <table class="table table-striped table-bordered">
        ...
        <tr>
            ...
            <th width="80" align="left">
                <?php echo Yii::t('common', 'quantity'); ?>
            </th>
            <th width="110" align="left">
        ...
        <?php foreach ($products as $product) { ?>
            <tr>
                ...
                <td>
                    ...
                    ?>
                    <?php echo '<a href="' . $url . '">' . $product["name"] . ((isset($product['label_ext']) && $product['label_ext']) ? ' - ' . $product['label_ext'] : '') . '</a>.'; ?>
                    <?php
                ...
                <td>
                    <?php
                    if (isset($product['product_price']) && $product['product_price']) {
                        echo number_format($product['product_price'] * $product['product_qty'], 0, ',', '.'), $model->currency;
                    } else {
