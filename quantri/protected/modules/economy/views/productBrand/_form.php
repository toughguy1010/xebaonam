...
<script type="text/javascript">
    jQuery(document).ready(function () {
        //
        CKEDITOR.replace("ProductBrand_description", {
            height: 200,
    ...
    <div class="col-xs-12 no-padding">
        ...
        <div class="control-group form-group">
            ...
            <div class="controls col-sm-10">
                ...
                <div id="productBrandavatar" style="display: block; margin-top: 0px;">
                    <div id="productBrandavatar_img" style="display: inline-block; max-width: 100px; max-height: 100px; overflow: hidden; vertical-align: top; <?php if ($model->avatar) echo 'margin-right: 10px;'; ?>">  
                    ...
                    <div id="productBrand_upload" style="display: inline-block;">
        ...
        <div class="control-group form-group buttons">
            <div class="col-sm-offset-2 col-sm-10">
                <?php echo CHtml::submitButton($model->isNewRecord ? Yii::t('product', 'productBrand_create') : Yii::t('product', 'productBrand_update'), array('class' => 'btn btn-primary', 'id' => 'btnAddManu')); ?>
            </div>
        </div>
        <?php $this->endWidget(); ?>
    </div>
...
<script type="text/javascript">
    jQuery(function ($) {
        jQuery('#productBrand_upload').ajaxUpload({
            url: '<?php echo Yii::app()->createUrl("/economy/productBrand/uploadfile"); ?>',
            name: 'file',
            onSubmit: function () {
            },
            onComplete: function (result) {
                ...
                if (obj.status == '200') {
                    if (obj.data.realurl) {
                        jQuery('#ProductBrand_avatar').val(obj.data.avatar);
                        if (jQuery('#productBrandavatar_img img').attr('src')) {
                            jQuery('#productBrandavatar_img img').attr('src', obj.data.realurl);
                        } else {
                            jQuery('#productBrandavatar_img').append('<img src="' + obj.data.realurl + '" />');
                        }
                        jQuery('#productBrandavatar_img').css({"margin-right": "10px"});
                    }
                }
            }
        });
