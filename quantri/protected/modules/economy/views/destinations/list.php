...
<div class="widget-box">
    <div class="widget-header">
        <h4>
            <?php echo Yii::t('rent', 'destinations'); ?>
        </h4>

        <div class="widget-toolbar no-border">
            <a href="<?php echo Yii::app()->createUrl('economy/destinations/create', array('id' => ClaCategory::CATEGORY_ROOT)); ?>"
               class="btn btn-xs btn-primary" style="margin-right: 20px;">
                <i class="icon-plus"></i>
                <?php echo Yii::t('rent', 'add_destinations'); ?>
            </a>
            <a href="<?php echo Yii::app()->createUrl('economy/destinations/delallcat'); ?>"
                ...
                <div class="pageSizebox" style="position: absolute; right: 0px; top: 0px;">
                    <div class="pageSizealign">
                        ...
                        $this->widget('common.extensions.PageSize.PageSize', array(
                            'mGridId' => 'tour-categories-grid', //Gridview id
            ...
            $this->widget('zii.widgets.grid.CGridView', array(
                ...
                'columns' => array(
                    ...
                    array(
                        ...
                        'buttons' => array(
                            'update' => array(
                                'label' => '',
                                'imageUrl' => false,
                                'url' => 'Yii::app()->createUrl("economy/destinations/update", array("id" => $data["id"]))',
                                'options' => array('class' => 'icon-edit', 'title' => Yii::t('common', 'update')),
                            ),
                            'delete' => array(
                                'label' => '',
                                'imageUrl' => false,
                                'url' => 'Yii::app()->createUrl("economy/destinations/delete", array("id" => $data["id"]))',
                    ...
                    'translate' => array(
                        ...
                        'value' => function ($data) {
                            $this->widget('application.widgets.translate.translate', array('baseUrl' => '/economy/destinations/update', 'params' => array('id' => $data['id'])));
                        }
                    ),
                ),
            ));
