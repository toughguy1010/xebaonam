<div class="widget widget-box no-border">
    <div class="widget-header"><h4>
            <?php echo Yii::t('product', 'product_to_tag'); ?>
        </h4></div>
...
//                                                    ),
                            ...
                            <div class="col-sm-5" id="choicedproduct">
                                ...
                                <div class="widget-box">
                                    <div class="widget-header header-color-green2">
                                        ...
                                        <div class="widget-toolbar no-border">
                                            <?php echo CHtml::submitButton(Yii::t('product', 'choiced_product_save'), array('class' => 'btn btn-xs btn-primary imageTag', 'id' => 'btnProductSave')); ?>
                                        </div>
                                ...
                                <?php
                                echo CHtml::hiddenField('rel_products', '', array('id' => 'choicedProducts'));
                                ?>
                                <?php
                                $this->endWidget();
                                ?>
