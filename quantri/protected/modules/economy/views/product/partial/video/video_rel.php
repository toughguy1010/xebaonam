...
<?php } else { ?>
    ...
    <a id="addVideos"
       href="<?php echo Yii::app()->createUrl('economy/product/addVideoToRelation', array('pid' => $model->id)) ?>"
    ...
    $this->widget('zii.widgets.grid.CGridView', array(
        ...
        'columns' => array(
            ...
            'order' => array(
                ...
                'type' => 'raw',
                'value' => function ($data) {
                    return '<input onchange="update(this,' . $data->video_id . ')" type="text" value="' . $data->order . '">';
                },
                'htmlOptions' => array('width' => '30px',),
            ),
            array(
                ...
                'deleteButtonLabel' => '',
                'deleteButtonUrl' => 'Yii::app()->createUrl("/economy/product/deleteVideoInRel",array("product_id"=>$data["product_id"],"video_id"=>$data["video_id"]))',
            ),
        ),
    ));
    ?>
    <script>
        ...
        function update(e, item_id) {
            ...
            var url = "<?php echo Yii::app()->createUrl("/economy/product/updateOrderVideo", array("id" => $model->id));?>";
            $.ajax({
                url: url,
                dataType: "json",
