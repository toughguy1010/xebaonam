                ...
                <div class="col-xs-12">
                    <div class="form-group">
                        <div class="row">
                                    ...
                                    <div class="widget-body">
                                        <div class="widget-main padding-8">
                                            <div class="search-active-form" style="position: relative; margin-top: 10px;">
                                                <?php
                                                $this->renderPartial('partial_news_rel/_searchnews_manual', array(
                                                    'newsModel' => $newsModel,
                                                ));
                                                ?>
                                            </div><!-- search-form -->
                            ...
                            <div class="col-sm-5" id="choicedproduct_manual">
                                <?php
                                $form = $this->beginWidget('CActiveForm', array(
                                    'id' => 'news-groups-form-manual',
                                ...
                                <div class="widget-box">
                                    <div class="widget-header header-color-green2">
                                        ...
                                        <div class="widget-toolbar no-border">
                                            <?php echo CHtml::submitButton(Yii::t('product', 'choiced_product_save'), array('class' => 'btn btn-xs btn-primary', 'id' => 'btnProductSave_manual')); ?>
                                        </div>

                                    </div>
                                    <div class="widget-body">
                                        <div class="widget-main padding-8">
                                            <table class="table table-bordered table-hover vertical-center products_manual">
                                                <thead>
                                                    <tr>
                                ...
                                <?php
                                echo CHtml::hiddenField('rel_news', '', array('id' => 'choicedProducts_manual'));
                                ?>
                                <?php
                                $this->endWidget();
                                ?>
...
<?php $this->renderPartial('partial_news_rel/script_manual', array('isAjax' => $isAjax)); ?>