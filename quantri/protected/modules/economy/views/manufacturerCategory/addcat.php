...
<div class="widget widget-box">
    <div class="widget-header"><h4>
            <?php echo Yii::app()->controller->action->id != "update" ? Yii::t('manufacturer', 'add_category') : Yii::t('manufacturer', 'update_category'); ?>
        </h4></div>
            ...
            <div class="row">
                <div class="col-xs-12 no-padding">
                    ...
                    <div class="control-group form-group">
                        ...
                        <div class="controls col-sm-10">
                            <?php echo $form->dropDownList($model, 'type', ManufacturerCategories::optionsType(), array('class' => 'span10 col-sm-4', 'prompt' => '--- Chọn loại---')); ?>
                    ...
                    <div class="control-group form-group">
                        <?php echo $form->labelEx($model, 'show_in_filter', array('class' => 'col-sm-2 control-label no-padding-left')); ?>
                        <div class="controls col-sm-10">
                            <?php echo $form->checkBox($model, 'show_in_filter'); ?>
                            <?php echo $form->error($model, 'show_in_filter'); ?>
                        </div>
                    </div>
                    ...
                    <div class="control-group form-group">
                        ...
                        <div class="controls col-sm-10">
                            ...
                            <div id="manufacturercategoryravatar" style="display: block; margin-top: 0px;">
                                <div id="manufacturercategoryavatar_img" style="display: inline-block; max-width: 100px; max-height: 100px; overflow: hidden; vertical-align: top; <?php if ($model->avatar) echo 'margin-right: 10px;'; ?>">
                                ...
                                <div id="manufacturercategoryavatar_form" style="display: inline-block;">
                    ...
                    <div class="control-group form-group">
                        ...
                        <div class="controls col-sm-10">
                            <select data-placeholder="Chọn sản phẩm" name="ManufacturerCategories[product_id]" id="ManufacturerCategories_product_id"
...
<script type="text/javascript">
    jQuery(function ($) {
        jQuery('#manufacturercategoryavatar_form').ajaxUpload({
            url: '<?php echo Yii::app()->createUrl("/economy/manufacturerCategory/uploadfile"); ?>',
            name: 'file',
            onSubmit: function () {
            },
            onComplete: function (result) {
                ...
                if (obj.status == '200') {
                    if (obj.data.realurl) {
                        jQuery('#ManufacturerCategories_avatar').val(obj.data.avatar);
                        if (jQuery('#manufacturercategoryavatar_img img').attr('src')) {
                            jQuery('#manufacturercategoryvatar_img img').attr('src', obj.data.realurl);
                        } else {
                            jQuery('#manufacturercategoryavatar_img').append('<img src="' + obj.data.realurl + '" />');
                        }
                        jQuery('#manufacturercategoryavatar_img').css({"margin-right": "10px"});
                    }
                }
            }
        });
