            ...
            <div class="tab-content">
                ...
                <div class="form-group no-margin-left">
                    ...
                    <div class="controls col-sm-10">
                        <?php echo $form->dropDownList($model, 'from_lang', ClaLocation::getCountries(), array('class' => '  select-beast')); ?>
                ...
                <div class="form-group no-margin-left">
                    ...
                    <div class="controls col-sm-10">
                        <?php echo $form->dropDownList($model, 'to_lang', ClaLocation::getCountries(), array('class' => ' select-beast')); ?>
                ...
                <div class="form-group no-margin-left">
                    <?php echo $form->labelEx($model, 'price_business', array('class' => 'col-sm-2 control-label no-padding-left')); ?>
                    <div class="controls col-sm-10">
                        <?php echo $form->textField($model, 'price_business', array('class' => 'span12 col-sm-12')); ?>
                        <?php echo $form->error($model, 'price_business'); ?>
                    </div>
                </div>
                <div class="form-group no-margin-left">
