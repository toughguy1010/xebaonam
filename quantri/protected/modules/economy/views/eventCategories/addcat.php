                ...
                <div class="col-xs-12 no-padding">
                    ...
                    <div class="control-group form-group">
                        ...
                        <div class="controls col-sm-10">
                            ...
                            <div id="eventcategoryravatar" style="display: block; margin-top: 0px;">
                                <div id="eventcategoryavatar_img" style="display: inline-block; max-width: 100px; max-height: 100px; overflow: hidden; vertical-align: top; <?php if ($model->avatar) echo 'margin-right: 10px;'; ?>">  
                                ...
                                <div id="eventcategoryavatar_form" style="display: inline-block;">
...
<script type="text/javascript">
    jQuery(function ($) {
        jQuery('#eventcategoryavatar_form').ajaxUpload({
            url: '<?php echo Yii::app()->createUrl("/economy/eventCategories/uploadfile"); ?>',
            name: 'file',
            onSubmit: function () {
            },
            onComplete: function (result) {
                ...
                if (obj.status == '200') {
                    if (obj.data.realurl) {
                        jQuery('#EventCategories_avatar').val(obj.data.avatar);
                        if (jQuery('#eventcategoryavatar_img img').attr('src')) {
                            jQuery('#eventcategoryvatar_img img').attr('src', obj.data.realurl);
                        } else {
                            jQuery('#eventcategoryavatar_img').append('<img src="' + obj.data.realurl + '" />');
                        }
                        jQuery('#eventcategoryavatar_img').css({"margin-right": "10px"});
                    }
                }
            }
        });
