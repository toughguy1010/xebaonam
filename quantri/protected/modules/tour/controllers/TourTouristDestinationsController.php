...
class TourTouristDestinationsController extends BackController {
    ...
    public function actionCreate() {
        ...
        $this->breadcrumbs = array(
            Yii::t('tour', 'manager_tourist_destinations') => Yii::app()->createUrl('/tour/tourTouristDestinations/'),
            Yii::t('tour', 'add_tourist_destinations') => Yii::app()->createUrl('/tour/tourTouristDestinations/create'),
        );

        $this->setPageTitle(Yii::t('tour', 'add_tourist_destinations'));
        $model = new TourTouristDestinations();

        $post = Yii::app()->request->getPost('TourTouristDestinations');
        ...
        if (Yii::app()->request->isPostRequest && $post) {
            ...
            if ($model->save()) {
                ...
                $this->redirect(Yii::app()->createUrl("/tour/tourTouristDestinations"));
            }
        }
    ...
    public function actionUpdate($id) {
        ...
        $this->breadcrumbs = array(
            Yii::t('tour', 'manager_tourist_destinations') => Yii::app()->createUrl('/tour/tourTouristDestinations/'),
            Yii::t('tour', 'update_tourist_destinations') => Yii::app()->createUrl('/tour/tourTouristDestinations/update', array('id' => $id)),
        );
    ...
    public function actionDelete($id) {
        ...
        $model = TourTouristDestinations::model()->findByPk($id);
        if (!$model) {
    ...
    public function actionUploadfile() {
        if (isset($_FILES['file'])) {
            ...
            $up->setPath(array($this->site_id, 'tourist_destinations', 'ava'));
            $up->uploadImage();
            $return = array();
