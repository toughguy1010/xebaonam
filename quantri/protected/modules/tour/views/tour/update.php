<div class="widget widget-box">
    <div class="widget-header">
        <h4><?php echo Yii::t('tour', 'tour_edit'); ?></h4>
        <div class="widget-toolbar no-border">
            <a style="margin-right: 20px;" class="btn btn-xs btn-primary" id="savetour" href="#" validate="<?php echo Yii::app()->createUrl('tour/tour/validate'); ?>">
                <i class="icon-ok"></i>
    ...
    <div class="widget-body no-padding">
        <div class="widget-main">
            <?php $this->renderPartial('_form', array('model' => $model, 'category' => $category, 'tourInfo' => $tourInfo, 'options_partners' => $options_partners,'options_destinations' => $options_destinations)); ?>
        </div>
    </div>
</div>
