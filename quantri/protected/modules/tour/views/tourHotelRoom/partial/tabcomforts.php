<?php
$comforts = TourHotel::getAllComfortsRoom();
...
<?php if (count($comforts)) { ?>
    ...
    <?php foreach ($comforts as $comfort) { ?>
        <div class="col-xs-4 checkbox">
            <label>
                <input <?php echo in_array($comfort['id'], $ary_comfort) ? 'checked' : '' ?> name="TourHotelRoom[comforts][]" value="<?php echo $comfort['id'] ?>" class="ace ace-checkbox-2" type="checkbox">
