<div class="widget widget-box">
    <div class="widget-header">
        <h4><?php echo Yii::t('tour', 'room_update'); ?></h4>
        <div class="widget-toolbar no-border">
            <a style="" class="btn btn-xs btn-primary" id="saveroom" href="#" validate="<?php echo Yii::app()->createUrl('tour/tourHotelRoom/validate'); ?>">
                <i class="icon-ok"></i>
    ...
    <div class="widget-body no-padding">
        <div class="widget-main">
            <?php $this->renderPartial('_form', array('model' => $model, 'option_hotel' => $option_hotel)); ?>
        </div>
    </div>
</div>
