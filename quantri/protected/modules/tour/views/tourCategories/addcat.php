...
<script type="text/javascript">
    jQuery(document).ready(function () {
        $('#ck-check').on("click", function () {
            if (this.checked) {
                CKEDITOR.replace("TourCategories_description", {
                    height: 400,
                    language: '<?php echo Yii::app()->language ?>'
                });
            } else {
                var a = CKEDITOR.instances['TourCategories_description'];
                if (a) {
                    a.destroy(true);
                }
...
<div class="widget widget-box">
    <div class="widget-header"><h4>
            <?php echo Yii::app()->controller->action->id != "update" ? Yii::t('tour', 'add_category') : Yii::t('tour', 'update_category'); ?>
        </h4></div>
                ...
                <div class="col-xs-12 no-padding">
                    ...
                    <div class="control-group form-group">
                        ...
                        <div class="controls col-sm-10">
                            ...
                            <div id="tourcategoryravatar" style="display: block; margin-top: 0px;">
                                <div id="tourcategoryavatar_img"
                                ...
                                <div id="tourcategoryavatar_form" style="display: inline-block;">
...
<script type="text/javascript">
    jQuery(function ($) {
        jQuery('#tourcategoryavatar_form').ajaxUpload({
            url: '<?php echo Yii::app()->createUrl("/tour/tourCategories/uploadfile"); ?>',
            name: 'file',
            onSubmit: function () {
            },
            onComplete: function (result) {
                ...
                if (obj.status == '200') {
                    if (obj.data.realurl) {
                        jQuery('#TourCategories_avatar').val(obj.data.avatar);
                        if (jQuery('#tourcategoryavatar_img img').attr('src')) {
                            jQuery('#tourcategoryvatar_img img').attr('src', obj.data.realurl);
                        } else {
                            jQuery('#tourcategoryavatar_img').append('<img src="' + obj.data.realurl + '" />');
                        }
                        jQuery('#tourcategoryavatar_img').css({"margin-right": "10px"});
                    }
                }
            }
        });
