...
<div class="widget-box">
    <div class="widget-header">
        ...
        <div class="widget-toolbar no-border">
            <a href="<?php echo Yii::app()->createUrl('media/video/create'); ?>" class="btn btn-xs btn-primary"
               style="margin-right: 20px;">
                <i class="icon-plus"></i>
                <?php echo Yii::t('video', 'video_create'); ?>
            </a>
            <a href="<?php echo Yii::app()->createUrl('media/video/deleteall'); ?>"
               class="btn btn-xs btn-danger delAllinGrid" grid="videos-grid">
            ...
            $this->widget('zii.widgets.grid.CGridView', array(
                ...
                'columns' => array(
                    ...
                    'status' => array(
                        'name' => 'status',
                        'value' => function ($data) {
                            return ActiveRecord::statusArray()[$data->status];
                        },
