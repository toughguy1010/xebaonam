 ...
 * Upload router
 */
class UploadController extends BPublicController {
    ...
    public function actionUploadimage() {
        ...
        if (Yii::app()->request->isPostRequest) {
            ...
            $first = reset($path);
            if ($first != $this->site_id) {
                $path = array_merge(array($this->site_id), $path);
            }
            //
            ...
            if ($up->getStatus() == '200') {
                ...
                if ($imgtemp->save()) {
                    $this->jsonResponse(200, array(
                        ...
                        'imgurl' => ClaUrl::getImageUrl($imgtemp->path,$imgtemp->name,['width'=>250,'height'=>250]),
