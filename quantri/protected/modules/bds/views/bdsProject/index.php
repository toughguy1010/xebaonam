...
<div class="widget-box">
    <div class="widget-header">
        <h4>
            <?php
            echo Yii::t('bds_project', 'project_manager');
            ?>
        </h4>

        <div class="widget-toolbar no-border">
            <a href="<?php echo Yii::app()->createUrl('bds/bdsProject/create'); ?>" class="btn btn-xs btn-primary" style="margin-right: 20px;">
                <i class="icon-plus"></i>
                <?php echo Yii::t('bds_project', 'project_create'); ?>
            </a>
            <a href="<?php echo Yii::app()->createUrl('bds/bdsProject/deleteall'); ?>" class="btn btn-xs btn-danger delAllinGrid" grid="project-grid">
