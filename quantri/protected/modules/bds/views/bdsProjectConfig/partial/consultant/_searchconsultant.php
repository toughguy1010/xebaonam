...
//    $option = $category->createOptionArray(ClaCategory::CATEGORY_ROOT, ClaCategory::CATEGORY_STEP, $option0);
    ?>
    <?php
    echo $form->textField($consultantModel, 'name', array('class' => '', 'placeholder' => $consultantModel->getAttributeLabel('name'))); ?>
<!--    --><?php //echo $form->dropDownList($consultantModel, 'folder_id', $option, array('class' => '')); ?>
