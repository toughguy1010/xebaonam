<div class="widget widget-box no-border">
    <div class="widget-header"><h4>
            <?php echo Yii::t('event', 'add_rel_file') . " '" . $model->name . "'"; ?>
        </h4></div>
                            ...
                            <div class="col-sm-7">
                                <div class="widget-box" id="searchproduct">
                                    <div class="widget-header header-color-grey">
                                        <h4 class="lighter smaller"><?php echo Yii::t('consultants', 'consultants'); ?></h4>
                                    </div>
                                    <div class="widget-body">
                                        <div class="widget-main padding-8">
                                            <div class="search-active-form"
                                                ...
                                                <?php
                                                $this->renderPartial('partial/consultant/_searchconsultant', array(
                                            ...
                                            $this->widget('zii.widgets.grid.CGridView', array(
                                                'id' => 'products-grid',
                                                'summaryText' => '',
                                                'dataProvider' => $consultantModel->search(),
                            ...
                            <div class="col-sm-5" id="choicedproduct">
                                ...
                                <div class="widget-box">
                                    <div class="widget-header header-color-green2">
                                        <h4 class="lighter smaller"><?php echo Yii::t('consultant', 'choiced_consultant') ?></h4>
                                        <div class="widget-toolbar no-border">
                                            <?php echo CHtml::submitButton(Yii::t('consultant', 'choiced_consultant_save'), array('class' => 'btn btn-xs btn-primary', 'id' => 'btnProductSave')); ?>
                                        </div>
                                            ...
                                            <table class="table table-bordered table-hover vertical-center products">
                                                ...
                                                <tr>
                                                    <th id="products-grid_c0">
                                                        <?php echo $consultantModel->getAttributeLabel('consultant_title'); ?>
                                                    </th>
                                ...
                                <?php
                                echo CHtml::hiddenField('rel_consultant', $consultant_ids, array('id' => 'choicedProducts'));
                                ?>
                                <?php
                                $this->endWidget();
                                ?>
...
<?php
$this->renderPartial('partial/consultant/script', array('isAjax' => $isAjax, 'model_info_consultant' => $consultant_ids)); ?>