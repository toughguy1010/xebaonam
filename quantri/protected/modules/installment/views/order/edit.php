                ...
                <div class="widget-box transparent invoice-box">
                    <div class="widget-header widget-header-large clearfix">
                        <div class="col-xs-8">
                            ...
                            <br/>
                            <label><?php echo $model->getAttributeLabel('transport_freight'); ?> : </label>
                            <?php
                            echo $form->textField($model, 'transport_freight', ['class' => 'numberFormat']);
                            echo $form->error($model, 'transport_freight');
                            ?>
                            <br/>
                            <label><?php echo 'Triết khấu (%)'; ?> : </label>
                            <?php
                            echo $form->textField($model, 'discount_percent', ['class' => '']);
                            echo $form->error($model, 'discount_percent');
                            ?>
                            <br/>
                            <?php if ($model->order_status != 6 && $model->order_status != 5) { ?>
                            ...
                            <div class="row">
                                ...
                                <div class="widget-toolbar hidden-480">
                                    ...
                                    <a title="In hóa đơn lớn" target="_blank"
                                       href="<?php echo Yii::app()->createUrl('/economy/order/printBillAdmin', array('id' => $model->order_id)) ?>">
                                        <i class="icon-print"></i>
                                    </a>
                                    <?php if (Yii::app()->controller->site_id != 1424) { ?>
                                        <a title="In hóa đơn bé" target="_blank"
                                           href="<?php echo Yii::app()->createUrl('/economy/order/printbill', array('id' => $model->order_id)) ?>">
                                            <i class="icon-print"></i>
                                        </a>
                                    <?php } ?>
                                </div>
                    ...
                    <div class="widget-body">
                        <div class="widget-main padding-24">
                            ...
                            <div class="space"></div>
                            <div>
                                <?php $this->renderPartial('_products_bill_admin', array('products' => $products)); ?>
                            </div>
