...
<div class="widget-box">
    <div class="widget-header">
        ...
        <div class="widget-toolbar no-border">
            <a href="<?php echo Yii::app()->createUrl('banner/banner/create'); ?>" class="btn btn-xs btn-primary" style="margin-right: 20px;">
                <i class="icon-plus"></i>
                <?php echo Yii::t('banner', 'banner_create_new'); ?>
            </a>
            <a href="<?php echo Yii::app()->createUrl('banner/banner/deleteall'); ?>" class="btn btn-xs btn-danger delAllinGrid" grid="banners-grid">
        ...
        <div class="widget-main">
            ...
            $this->widget('zii.widgets.grid.CGridView', array(
                ...
                'columns' => array(
                    ...
                    return '<a href="' . Yii::app()->createUrl('/banner/bannergroup/list', array('bgid' => $data->banner_group_id)) . '">' . $bannergroup[$data->banner_group_id] . '</a>';
                },
                    ),
                    'actived' => array(
                        'name' => 'actived',
                    ...
                    'translate' => array(
                        ...
                        'value' => function($data) {
                    $this->widget('application.widgets.translate.translate', array('baseUrl' => '/banner/banner/update', 'params' => array('id' => $data->banner_id), 'model' => $data));
                }
                    ),
                ),
            ));
