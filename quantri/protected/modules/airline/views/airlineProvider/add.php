                ...
                <div class="col-xs-12 no-padding">
                    ...
                    <div class="control-group form-group">
                        ...
                        <div class="controls col-sm-10">
                            ...
                            <div id="airlineProvideravatar" style="display: block; margin-top: 0px;">
                                <div id="airlineProvideravatar_img" style="display: inline-block; max-width: 100px; max-height: 100px; overflow: hidden; vertical-align: top; <?php if ($model->avatar) echo 'margin-right: 10px;'; ?>">  
                                ...
                                <div id="airlineProvideravatar_form" style="display: inline-block;">
...
<script type="text/javascript">
    jQuery(function ($) {
        jQuery('#airlineProvideravatar_form').ajaxUpload({
            url: '<?php echo Yii::app()->createUrl("/airline/airlineProvider/uploadfile"); ?>',
            name: 'file',
            onSubmit: function () {
            },
            onComplete: function (result) {
                ...
                if (obj.status == '200') {
                    if (obj.data.realurl) {
                        jQuery('#AirlineProvider_avatar').val(obj.data.avatar);
                        if (jQuery('#airlineProvideravatar_img img').attr('src')) {
                            jQuery('#airlineProvideravatar_img img').attr('src', obj.data.realurl);
                        } else {
                            jQuery('#airlineProvideravatar_img').append('<img src="' + obj.data.realurl + '" />');
                        }
                        jQuery('#airlineProvideravatar_img').css({"margin-right": "10px"});
                    }
                }
            }
        });
