        ...
        <div class="widget-main">
            <div class="row">
                <div class="col-xs-12 no-padding">
                    ...
                    <div class="control-group form-group">
                        <?php echo $form->labelEx($model, 'initials_name', array('class' => 'col-sm-2 control-label no-padding-left')); ?>
                        <div class="controls col-sm-10">
                            <?php echo $form->textField($model, 'initials_name', array('class' => 'span10 col-sm-12')); ?>
                            <?php echo $form->error($model, 'initials_name'); ?>
                        </div>
                    </div>
                    <div class="control-group form-group">
