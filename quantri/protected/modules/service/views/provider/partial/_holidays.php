...
$dayOffs = isset($dayOffs) ? $dayOffs : SeDaysoff::getDaysOff(array('provider_id' => $model->id, 'keyField' => 'id'));
?>
<div class="box-setting-calendar">
    <div class="calendar-year">
        <p class="box-center">
            <button class="btn btn-default changeYear" type="button" href="<?php echo Yii::app()->createUrl('service/provider/getcalendar', array('provider_id'=>$model->id,'year' => $year, 'type' => 'prev')) ?>">
                <i class="icon-angle-left"></i>
            </button>
            <span><?php echo $year ?></span>
            <button class="btn btn-default changeYear" type="button" href="<?php echo Yii::app()->createUrl('service/provider/getcalendar', array('provider_id'=>$model->id,'year' => $year, 'type' => 'next')) ?>">
                        ...
                        <div class="calendar-day">
                            ...
                            for ($i = 1; $i <= $daysInMonth; $i++) {
                                ...
                                <div class="day <?php echo ($isOff) ? 'off' : ''; ?>">
                                    <a class="setoff" href="<?php echo Yii::app()->createUrl('service/provider/setdayoff',array('provider_id'=>$model->id,)) ?>" data-day="<?php echo $i ?>" data-month="<?php echo $monthIndex; ?>" data-year="<?php echo $year; ?>" <?php if ($isOff) { ?> data-off="1" data-id="<?php echo $isOff; ?>" <?php } ?> data-workrepeat="<?php echo $repeat; ?>">
                                        <?php echo $i; ?>
                                    </a>
                                </div>
                            <?php } ?>
