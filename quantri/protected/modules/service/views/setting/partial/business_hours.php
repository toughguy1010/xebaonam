...
<div class="col-sm-9">
    ...
    foreach ($businessHours as $dayIndex => $hour) {
        ...
        ?>
        <label class="col-sm-12"><strong><?php echo ClaDateTime::getDayTextFromIndex($hour['day_index']); ?></strong></label>
        <div class="form-group no-margin-left bsTime">
            <div class="controls col-sm-4 sstime">
                <?php echo CHtml::dropDownList("BusinessHours[".$hour['day_index']."][start_time]", $hour['start_time'], $timeOptions, array('class' => 'form-control')); ?>
            </div>
            ...
            <div class="controls col-sm-4 setime <?php echo $hidden; ?>">
                <?php echo CHtml::dropDownList("BusinessHours[".$hour['day_index']."][end_time]", $hour['end_time'], $timeOptions, array('class' => 'form-control')); ?>
            </div>
        </div>
    <?php } ?>
