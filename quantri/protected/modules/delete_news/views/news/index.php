...
<div class="widget-box">
    <div class="widget-header">
        ...
        <div class="widget-toolbar no-border">
            <a href="<?php echo Yii::app()->createUrl('news/news/create'); ?>" class="btn btn-xs btn-primary" style="margin-right: 20px;">
                <i class="icon-plus"></i>
                <?php echo Yii::t('news', 'news_create_new'); ?>
            </a>
            <a href="<?php echo Yii::app()->createUrl('news/news/deleteall'); ?>" class="btn btn-xs btn-danger delAllinGrid" grid="news-grid">
            ...
            $this->widget('zii.widgets.grid.CGridView', array(
                ...
                'columns' => array(
                    ...
                    'news_title' => array(
                        ...
                        'type' => 'raw',
                        'value' => function($data) {
                    return '<a href="' . Yii::app()->createUrl('news/news/update', array('id' => $data->news_id)) . '">' . $data->news_title . '</a>';
                }
                    ),
