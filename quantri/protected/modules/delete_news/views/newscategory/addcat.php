            ...
            <div class="row">
                <div class="col-xs-12 no-padding">
                    ...
                    <div class="control-group form-group buttons">
                        <?php echo CHtml::submitButton($model->isNewRecord ? Yii::t('category', 'category_create') : Yii::t('category', 'category_save'), array('class' => 'btn btn-info')); ?>
                    </div>
                    <?php
                    $this->endWidget();
                    ?>
...
<script type="text/javascript">
    jQuery(function($) {
        jQuery('#categoryavatar_form').ajaxUpload({
            url: '<?php echo Yii::app()->createUrl("/news/newscategory/uploadfile"); ?>',
            name: 'file',
            onSubmit: function() {
            },
