<div class="widget-box">
    <div class="widget-header">
        <h4>
            <?php echo Yii::t('form', 'form_statistic', array('{name}' => $form->form_name)); ?>
        </h4>

        <div class="widget-toolbar no-border">
            <a href="<?php echo Yii::app()->createUrl('custom/customform/exportcsv/id/'.$form->form_id);?>" class="btn btn-xs btn-success" style="margin-right: 20px;">
                <i class="icon-cogs"></i>
