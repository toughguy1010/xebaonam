 ...
 */
class AffiliateIntroduceController extends BackController
{
    ...
    public function actionIndex()
    {
        ...
        $this->breadcrumbs = array(
            Yii::t('affiliate', 'manager_users') => Yii::app()->createUrl('affiliate/affiliateIntroduce/index'),
        );
        //
        $this->breadcrumbs = array(
    ...
    public function actionUpdate($id)
    {
        ...
        $this->breadcrumbs = array(
            Yii::t('affiliate', 'manager_users') => Yii::app()->createUrl('affiliate/affiliateIntroduce/index'),
            Yii::t('affiliate', 'user_update') => Yii::app()->createUrl('affiliate/affiliateIntroduce/update', array('id' => $id)),
        );
        //
