...
class ExpertransAffiliateTransferMoneyController extends BackController {
    ...
    public function actionUpdate($id) {
        ...
        $this->breadcrumbs = array(
            Yii::t('affiliate', 'affiliate_transfer_money') => Yii::app()->createUrl('affiliate/expertransAffiliateTransferMoney/'),
            Yii::t('affiliate', 'update_transfer_money') => Yii::app()->createUrl('affiliate/expertransAffiliateTransferMoney/update', array('id' => $id)),
        );
