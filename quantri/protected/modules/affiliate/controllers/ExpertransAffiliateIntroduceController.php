 ...
 */
class ExpertransAffiliateIntroduceController extends BackController
{
    ...
    public function actionIndex()
    {
        ...
        $this->breadcrumbs = array(
            Yii::t('affiliate', 'manager_users') => Yii::app()->createUrl('affiliate/expertransAffiliateIntroduce/index'),
        );
        //
        $this->breadcrumbs = array(
    ...
    public function actionUpdate($id)
    {
        ...
        $this->breadcrumbs = array(
            Yii::t('affiliate', 'manager_users') => Yii::app()->createUrl('affiliate/expertransAffiliateIntroduce/index'),
            Yii::t('affiliate', 'user_update') => Yii::app()->createUrl('affiliate/expertransAffiliateIntroduce/update', array('id' => $id)),
        );
        //
    ...
    {
        //
        $user = ExpertransContactFormModel::model()->findByPk($id);
        //
        if ($user === NULL) {
