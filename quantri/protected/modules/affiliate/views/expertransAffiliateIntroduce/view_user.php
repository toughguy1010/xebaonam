...
<div class="content bg-white border-b">
    <div class="row items-push text-uppercase" style="height: 90px;">
        ...
        <div class="col-xs-6 col-sm-2">
            ...
            <a class="h3 font-w300 text-primary animated flipInX" href="javascript:void(0)"
               id="tour_ov_success_revenue">
                <span id="summary_payout_success"
                      class="summary_item"><?= number_format($commission[Orders::ORDER_COMPLETE], 0, ',', '.') ?></span><sup>₫</sup>
            </a>
        </div>
        <div class="col-xs-6 col-sm-2">
            <div class="font-w700 text-gray-darker animated fadeIn">Hoa hồng</div>
            ...
            <a class="h3 font-w300 text-primary animated flipInX" href="javascript:void(0)"
               id="tour_ov_pending_revenue">
                <span id="summary_payout_pending"
                      class="summary_item"><?= number_format($commission[Orders::ORDER_WAITFORPROCESS], 0, ',', '.') ?></span><sup>₫</sup>
            </a>
        </div>
    </div>
</div>
