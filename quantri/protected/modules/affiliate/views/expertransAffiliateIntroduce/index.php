            ...
            $this->widget('zii.widgets.grid.CGridView', array(
                ...
                'columns' => array(
                    ...
                    array(
                        ...
                        'buttons' => array(
                            'update' => array(
                                'url' => 'Yii::app()->createUrl("affiliate/expertransAffiliateIntroduce/updateUser", array("id"=>$data->id))',
                            ),
                            'view' => array(
                                'url' => 'Yii::app()->createUrl("affiliate/expertransAffiliateIntroduce/viewUser", array("id"=>$data->id))',
                            ),
                            'delete' => array(
                                'url' => 'Yii::app()->createUrl("affiliate/expertransAffiliateIntroduce/delete", array("id"=>$data->id))',
                            ),
                        ),
                    ),
                ),
