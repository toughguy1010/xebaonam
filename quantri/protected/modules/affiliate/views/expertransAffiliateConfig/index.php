...
<!--                    <div class="control-group form-group">-->
<!--                        --><?php //echo $form->labelEx($model, 'commission_introduce', array('class' => 'col-sm-2 control-label no-padding-left')); ?>
<!--                        <div class="controls col-sm-10">-->
<!--                            --><?php //echo $form->textField($model, 'commission_introduce', array('class' => 'span9 col-sm-12')); ?>
<!--                            <span class="help-inline">-->
<!--                                --><?php //echo $form->error($model, 'commission_introduce'); ?>
<!--                            </span>-->
<!--                        </div>-->
<!--                    </div>-->
                    <div class="control-group form-group">
