            ...
            <div class="row">
                <div class="col-xs-12 no-padding">
                    ...
                    <div class="control-group form-group">
                        ...
                        <div class="controls col-sm-10">
                            <?php echo $form->dropDownList($model, 'category_id', CarAttributeCategory::optionCategory(), array('class' => 'span10 col-sm-12')); ?>
                    ...
                    <div class="well well-lg clearfix">
                        ...
                        <?php
                        $values = CarAttributeOption::getAllValues($model->id);
                        ?>
                        <div class="wrap_options_value">
                            ...
                            if (isset($values) && count($values)) {
                                foreach ($values as $value) {
                                    ...
                                    <div class="options">
                                        <div class="col-xs-6">
                                            ...
                                            <input class="form-control" type="text" name="CarAttributeOptionValueExist[<?= $value['id'] ?>][name]" value="<?= $value['name'] ?>" />
                                        </div>
                                        <div class="col-xs-1">
                                            <label style="display: block">Sắp xếp: </label>
                                            <input class="form-control" type="text" name="CarAttributeOptionValueExist[<?= $value['id'] ?>][order]" value="<?= $value['order'] ?>" />
                                        </div>
                                ...
                                <div class="options">
                                    <div class="col-xs-6">
                                        <label style="display: block">Giá trị: </label>
                                        <input class="form-control" type="text" name="CarAttributeOptionValue[1][name]" value="" />
                                    </div>
                                    <div class="col-xs-1">
                                        <label style="display: block">Sắp xếp: </label>
                                        <input class="form-control" type="text" name="CarAttributeOptionValue[1][order]" value="" />
                                    </div>
                                    <div style="clear: both; margin-bottom: 10px"></div>
                                </div>
                            <?php } ?>
...
<script type="text/javascript">
    ...
    function addhtmloption() {
        ...
        html += '<input class="form-control" type="text" name="CarAttributeOptionValue[' + count + '][name]" value="" />';
        html += '</div>';
        html += '<div class="col-xs-1">';
        html += '<label style="display: block">Sắp xếp: </label>';
        html += '<input class="form-control" type="text" name="CarAttributeOptionValue[' + count + '][order]" value="" />';
        html += '</div>';
