                ...
                <div class="col-xs-12 no-padding">
                    ...
                    <div class="control-group form-group">
                        ...
                        <div class="controls col-sm-10">
                            ...
                            <div id="carcategoryravatar" style="display: block; margin-top: 0px;">
                                <div id="carcategoryavatar_img" style="display: inline-block; max-width: 100px; max-height: 100px; overflow: hidden; vertical-align: top; <?php if ($model->avatar) echo 'margin-right: 10px;'; ?>">  
                                ...
                                <div id="carcategoryavatar_form" style="display: inline-block;">
...
<script type="text/javascript">
    jQuery(function ($) {
        jQuery('#carcategoryavatar_form').ajaxUpload({
            ...
            onComplete: function (result) {
                ...
                if (obj.status == '200') {
                    if (obj.data.realurl) {
                        jQuery('#CarCategories_avatar').val(obj.data.avatar);
                        if (jQuery('#carcategoryavatar_img img').attr('src')) {
                            jQuery('#carcategoryvatar_img img').attr('src', obj.data.realurl);
                        } else {
                            jQuery('#carcategoryavatar_img').append('<img src="' + obj.data.realurl + '" />');
                        }
                        jQuery('#carcategoryavatar_img').css({"margin-right": "10px"});
                    }
                }
            }
        });
