...
<div class="widget-box">
    <div class="widget-header">
        <h4>
            <?php echo Yii::t('car', 'manager_category'); ?>
        </h4>

        <div class="widget-toolbar no-border">
            <a href="<?php echo Yii::app()->createUrl('car/carCategories/create', array('id' => ClaCategory::CATEGORY_ROOT)); ?>" class="btn btn-xs btn-primary" style="margin-right: 20px;">
                <i class="icon-plus"></i>
                <?php echo Yii::t('category', 'category_add_new'); ?>
            </a>
            <a href="<?php echo Yii::app()->createUrl('car/carCategories/delallcat'); ?>" class="btn btn-xs btn-danger delAllinGrid" grid="news-categories-grid">
            ...
            $this->widget('zii.widgets.grid.CGridView', array(
                ...
                'columns' => array(
                    ...
                    'cat_order' => array(
                        ...
                        'type' => 'raw',
                        'value' => function($data) {
                    return CHtml::textField('cat_order', $data['cat_order'], array('class' => 'updateorder', 'style' => 'width: 50px;', 'rel' => Yii::app()->createUrl('car/productcategory/updateorder', array('id' => $data['cat_id'],))));
                },
                    ...
                    array(
                        ...
                        'buttons' => array(
                            '_addnew' => array(
                                'label' => '',
                                'url' => 'Yii::app()->createUrl("car/carCategories/create", array("id" => $data["cat_id"]))',
                                'options' => array('class' => 'icon-file-text', 'title' => Yii::t('product', 'product_create')),
                            ),
                            'update' => array(
                                'label' => '',
                                'imageUrl' => false,
                                'url' => 'Yii::app()->createUrl("car/carCategories/update", array("id" => $data["cat_id"]))',
                                'options' => array('class' => 'icon-edit', 'title' => Yii::t('common', 'update')),
                            ),
                            'delete' => array(
                                'label' => '',
                                'imageUrl' => false,
                                'url' => 'Yii::app()->createUrl("car/carCategories/delete", array("id" => $data["cat_id"]))',
