...
<div class="widget-box">
    <div class="widget-header">
        <h4>
            <?php echo Yii::t('car', 'manager_try_drive_car'); ?>
        </h4>
        ...
        <div class="widget-main">
            ...
            $this->widget('zii.widgets.grid.CGridView', array(
                ...
                'columns' => array(
                    ...
                    'car_id' => array(
                        'name' => 'car_id',
                        'value' => 'Car::getCarName($data->car_id)'
                    ),
                    'phone',
                    'email',
                    'date_coming' => array(
                        'name' => 'date_coming',
                        'value' => function($data) {
                            return ($data->date_coming) ? date('d-m-Y', $data->date_coming) : '';
                        }
                    ),
                    'time_coming',
                    'created_time' => array(
                        'name' => 'created_time',
                        'value' => function($data) {
                            return ($data->created_time) ? date('H:i d-m-Y', $data->created_time) : '';
                        }
                    ),
                    array(
                        'class' => 'CButtonColumn',
