<div class="widget widget-box">
    <div class="widget-header">
        <h4><?php echo Yii::t('car', 'car_update'); ?></h4>
        <div class="widget-toolbar no-border">
            <a style="margin-right: 20px;" class="btn btn-xs btn-primary" id="savecar" href="#" validate="<?php echo Yii::app()->createUrl('car/car/validate'); ?>">
                <i class="icon-ok"></i>
