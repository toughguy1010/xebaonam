...
<div class="widget-box">
    <div class="widget-header">
        ...
        <div class="widget-toolbar no-border">
            <a href="<?php echo Yii::app()->createUrl('menu/group/create'); ?>" class="btn btn-xs btn-primary" style="margin-right: 20px;">
                <i class="icon-plus"></i>
                <?php echo Yii::t('menu', 'menu_group_create') ?>
            </a>
            <a href="<?php echo Yii::app()->createUrl('menu/group/deleteall'); ?>" class="btn btn-xs btn-danger delAllinGrid" grid="menu-groups-grid">
            ...
            $this->widget('zii.widgets.grid.CGridView', array(
                ...
                'columns' => array(
                    ...
                    'menu_group_name' => array(
                        ...
                        'type' => 'raw',
                        'value' => function($data) {
                    return '<a href="' . Yii::app()->createUrl('/menu/group/list', array('mgid' => $data->menu_group_id)) . '">' . $data->menu_group_name . '</a>';
                }
                    ),
                    ...
                    array(
                        ...
                        'buttons' => array(
                            'delete' => array(
                                'url' => 'Yii::app()->createUrl("menu/group/delete",array("id"=>$data->menu_group_id))',
