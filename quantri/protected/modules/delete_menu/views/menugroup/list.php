...
<div class="widget-box">
    <div class="widget-header">
        ...
        <div class="widget-toolbar no-border">
            <a href="<?php echo Yii::app()->createUrl('/menu/menu/create', array('mgid' => $menugroup->menu_group_id)); ?>" class="btn btn-xs btn-primary" style="margin-right: 0px;">
                <i class="icon-plus"></i>
                    ...
                    array(
                        ...
                        'buttons' => array(
                            'update' => array(
                                'label' => '',
                                'imageUrl' => false,
                                'url' => 'Yii::app()->createUrl("menu/menu/update", array("id" => $data["menu_id"],"mgid"=>$data["menu_group"]))',
                                'options' => array('class' => 'icon-edit', 'title' => Yii::t('common', 'update')),
                            ),
                            'delete' => array(
                                'label' => '',
                                'imageUrl' => false,
                                'url' => 'Yii::app()->createUrl("menu/menu/delete", array("id" => $data["menu_id"],"mgid"=>$data["menu_group"]))',
