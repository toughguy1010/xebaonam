...
//
?>
<script type="text/javascript" src="<?= Yii::app()->baseUrl ?>/js/select2.min.js"></script>
<style type="text/css">
    .div-hidden {
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-4 col-lg-3">
                    ...
                    <p class="text-muted"> Tên của chiến dịch giảm giá của bạn (sẽ không được hiển thị cho khách hàng
                        của bạn) và số lần sử dụng cho một mã giảm giá.</p>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-8 col-lg-9">
                        ...
                        <div class="panel-body">
                            <div class="form-inline col-sm-12 no-padding">
                                <div class="fl sr">
                                    ...
                                    <div class="form-group" id="div_product_group">
                    ...
                    <script type="text/javascript">
                        $(document).ready(function () {
                            setTimeout(function(){$('#div_product').hide(); }, 500);
                            ...
                            $('#CouponCampaign_applies_to_resource').change(function () {
                                ...
                                if (apply_resource == 'minimum_order_amount') {
                                    ...
                                    $('#div_product_group').removeClass('div-hidden');
                ...
                <div class="row">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="controls">
                                            <label>
                                                <input type="radio" id="radio-generate"
                                                       name="CouponCampaign[import-or-generate]" value="generate"
                                                       checked="" onchange=""> Tạo mã giảm giá sử dụng một tiền tố
                                            </label>
                                        </div>
                                        <div class="controls">
                                            <label>
                                                <input type="radio" id="radio-import"
                                                       name="CouponCampaign[import-or-generate]" value="import"> Nhập mã
                                                giảm giá thủ công
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div id="discount-prefixes" class="row">
                                    <div class="col-md-6">
                                        ...
                                        <label class="text-muted" style="margin-top:10px;">Ví dụ mã dựa trên tiền tố của
                                            bạn:</label><br>
                                ...
                                <div id="discount-import" class="row div-hidden">
                                    <div class="col-sm-12">
                                        ...
                                        <textarea class="form-control" style="height:120px"
                                                  id="discount_set_import_codes"
                                                  name="CouponCampaign[discountset_import]"
                                                  placeholder="Enter xuống dòng để tạo thêm mã giảm giá"></textarea>
                                    </div>
                                    <div class="col-sm-12">
                                        <br>
                    ...
                    <script type="text/javascript">
                        $(document).ready(function () {
                            ...
                            $('#discount_set_import_codes').keypress(function (event) {
                ...
                <div class="row">
                    <div class="col-md-4 col-lg-3">
                        ...
                        <p class="text-muted">Lựa chọn nâng cao. Bỏ qua mục này nếu quý khách chưa được hướng dẫn.</p>
                    </div>
                    <div class="col-md-8 col-lg-9">
                        <div class="panel panel-default panel-light">
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-md-10">
                                        <?php echo $form->labelEx($model, 'is_auto_send', array('class' => 'strong')); ?>
                                        <div class=" margin-right">
                                            <?php echo $form->checkbox($model, 'is_auto_send', array('class' => 'form-ch')); ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
