...
<div class="widget-box">
    <div class="widget-header">
        <h4>
            <?php echo Yii::t('common', 'manager_ward'); ?>
        </h4>
        <div class="widget-toolbar no-border">
            <a href="<?php echo Yii::app()->createUrl('setting/libWards/create'); ?>" class="btn btn-xs btn-primary" style="margin-right: 20px;">
                <i class="icon-plus"></i>
            ...
            $this->widget('zii.widgets.grid.CGridView', array(
                ...
                'columns' => array(
                    ...
                    array(
                        ...
                        'buttons' => array(
                            'update' => array(
                                'label' => '',
                                'imageUrl' => false,
                                'url' => 'Yii::app()->createUrl("setting/libWards/update", array("id" => $data["ward_id"]))',
                    ...
                    'translate' => array(
                        ...
                        'value' => function($data) {
                    $this->widget('application.widgets.translate.translate', array('baseUrl' => 'setting/libWards/update', 'params' => array('id' => $data['ward_id'])));
                }
                    ),
                ),
            ));
