...
<div class="widget-box">
    <div class="widget-header">
        <h4>
            <?php echo Yii::t('common', 'manager_province'); ?>
        </h4>
        <div class="widget-toolbar no-border">
            <a href="<?php echo Yii::app()->createUrl('setting/libProvinces/create'); ?>" class="btn btn-xs btn-primary" style="margin-right: 20px;">
                <i class="icon-plus"></i>
                    ...
                    array(
                        ...
                        'buttons' => array(
                            'update' => array(
                                'label' => '',
                                'imageUrl' => false,
                                'url' => 'Yii::app()->createUrl("car/carCategories/update", array("id" => $data["province_id"]))',
