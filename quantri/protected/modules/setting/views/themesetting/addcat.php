...
<div class="widget widget-box">
    <div class="widget-header"><h4>
            <?php echo Yii::app()->controller->action->id != "editcat" ? Yii::t('category', 'category_theme_create') : Yii::t('category', 'category_theme_update'); ?>
        </h4></div>
            ...
            <div class="row">
                <div class="col-xs-12 no-padding">
                    ...
                    <div class="control-group form-group buttons">
                        <?php echo CHtml::submitButton($model->isNewRecord ? Yii::t('category', 'category_create') : Yii::t('category', 'category_save'), array('class' => 'btn btn-primary')); ?>
                    </div>
                    <?php
                    $this->endWidget();
                    ?>
    ...
    jQuery(function($) {
        jQuery('#categoryavatar_form').ajaxUpload({
            ...
            onComplete: function(result) {
                ...
                if (obj.status == '200') {
                    if (obj.data.realurl) {
                        jQuery('#ThemeCategories_avatar').val(obj.data.avatar);
