                                ...
                                <div class="col-md-5">
                                    ...
                                    <div class="input-group date margin-right">
                                        ...
                                        $this->widget('common.extensions.EJuiDateTimePicker.EJuiDateTimePicker', array(
                                            ...
                                            'value' => ((int) $model->released_date > 0 ) ? date('d-m-Y', (int) $model->released_date) : date('d-m-Y'),
                                            'language' => 'vi',
                                            'options' => array(
                                                'showSecond' => true,
                                                'dateFormat' => 'dd-mm-yy',
                                ...
                                <div class="col-md-5">
                                    ...
                                    <div class="input-group date margin-right">
                                        ...
                                        $this->widget('common.extensions.EJuiDateTimePicker.EJuiDateTimePicker', array(
                                            ...
                                            'mode' => 'date', //use "time","date" or "datetime" (default)
                                            'value' => ((int) $model->expired_date > 0 ) ? date('d-m-Y', (int) $model->expired_date) : date('d-m-Y'),
                                            'language' => 'vi',
                                            'options' => array(
                                                'showSecond' => true,
                                                'dateFormat' => 'dd-mm-yy',
