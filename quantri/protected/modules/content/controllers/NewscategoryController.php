...
class NewscategoryController extends BackController
{
    ...
    public function actionIndex()
    {
        ...
        $this->breadcrumbs = array(
            Yii::t('news', 'news_category') => Yii::app()->createUrl('/content/newscategory/'),
        );
        //
    ...
    public function actionAddcat($pa)
    {
        ...
        $this->breadcrumbs = array(
            Yii::t('news', 'news_category') => Yii::app()->createUrl('/content/newscategory/'),
            Yii::t('category', 'category_news_create') => Yii::app()->createUrl('content/newscategory/addcat', array('pa' => $pa)),
        );
        //
        if (!is_numeric($pa))
            return false;
        ...
        if (Yii::app()->request->isPostRequest && $post) {
            ...
            if ($model->save()) {
                ...
                if ($isAjax) {
                    ...
                    $this->redirect(Yii::app()->createUrl("/content/newscategory"));
            } else {
                if ($isAjax) {
    ...
    public function actionEditcat($id)
    {
        ...
        $this->breadcrumbs = array(
            Yii::t('news', 'news_category') => Yii::app()->createUrl('/content/newscategory/'),
            Yii::t('category', 'category_news_update') => Yii::app()->createUrl('content/newscategory/editcat', array('id' => $id)),
        );
        //
...
//        }
    ...
    public function loadModel($id, $noTranslate = false)
    {
        ...
        if (!$noTranslate) {
            $newscategory->setTranslate(false);
        }
        //
        $OldModel = $newscategory->findByPk($id);
        //
        //
        ...
        if (ClaSite::getLanguageTranslate()) {
            $newscategory->setTranslate(true);
            $model = $newscategory->findByPk($id);
