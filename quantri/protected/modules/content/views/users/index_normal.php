        ...
        <div class="widget-main">
            ...
            $this->widget('zii.widgets.grid.CGridView', array(
                ...
                'columns' => array(
                    ...
                    'bonus_point' => array('name' => 'status',
                        'header' => 'Điểm thưởng',
                        'type' => 'html',
                        'value' => function($data) {
                            echo '<a href="' . Yii::app()->createUrl('content/users/userBonusPointLog', array('id' => $data->user_id)) . '">' . $data->bonus_point . '</a>';
                        })
                        ,
                        array(
                            'header' => 'Đơn hàng',
                            'class' => 'CButtonColumn',
                            'template' => '{view}',
                            'viewButtonOptions' => array('class' => 'icon-shopping-cart'),
                            ...
                            'buttons' => array(
                                'view' => array(
                                    'url' => 'Yii::app()->createUrl("economy/order/userShoppingCart", array("id"=>$data->user_id))',
                                ),
                            ),
                        ),
                        array(
                            ...
                            'buttons' => array(
                                ...
                                'view' => array(
                                    'url' => 'Yii::app()->createUrl("content/users/viewNormal", array("id"=>$data->user_id))',
                                ),
                            ),
                        ),
                        'translate' => array(
