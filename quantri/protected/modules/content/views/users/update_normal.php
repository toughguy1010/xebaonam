<div class="row">
    <div class="col-xs-12 no-padding">
        ...
        <div class="control-group form-group">
            <?php echo $form->labelEx($model, 'facebook_url', array('class' => 'col-sm-2 control-label no-padding-left')); ?>
            <div class="controls col-sm-10">
                <?php echo $form->textField($model, 'facebook_url', array('class' => 'span12 col-sm-12')); ?>
