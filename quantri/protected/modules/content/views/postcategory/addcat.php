                    ...
                    'success': function(res) {
                        if (res.code != "200") {
                            ...
                            jQuery.ajax({
                                'type': 'POST',
                                'dataType': 'JSON',
                                'url': '<?php echo Yii::app()->createUrl('suggest/suggest/category', array('type' => ClaCategory::CATEGORY_POST)); ?>',
                                'success': function(res) {
                                    if (res.code == '200') {
                                        if (res.html)
                                            jQuery('#Posts_category_id').html(res.html);
...
<?php } ?>
        ...
        jQuery('#categoryavatar_form').ajaxUpload({
            ...
            onComplete: function(result) {
                ...
                if (obj.status == '200') {
                    if (obj.data.realurl) {
                        jQuery('#PostCategories_avatar').val(obj.data.avatar);
