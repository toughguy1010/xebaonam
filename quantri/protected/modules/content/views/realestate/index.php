...
<div class="widget-box">
    <div class="widget-header">
        <h4>
            <?php echo Yii::t('realestate', 'list_realestate'); ?>
        </h4>
        <div class="widget-toolbar no-border">
            <a href="<?php echo Yii::app()->createUrl('content/realestate/create'); ?>" class="btn btn-xs btn-primary" style="margin-right: 20px;">
                <i class="icon-plus"></i>
                <?php echo Yii::t('realestate', 'realestate_create'); ?>
            </a>
        </div>
    </div>
