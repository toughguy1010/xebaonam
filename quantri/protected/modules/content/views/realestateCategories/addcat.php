...
<div class="widget widget-box">
    <div class="widget-header"><h4>
            <?php echo Yii::app()->controller->action->id != "update" ? Yii::t('realestate', 'realestate_category_create') : Yii::t('realestate', 'realestate_category_update'); ?>
        </h4></div>
                ...
                <div class="col-xs-12 no-padding">
                    ...
                    <div class="control-group form-group">
                        ...
                        <div class="controls col-sm-10">
                            ...
                            <div id="realestatecategoryravatar" style="display: block; margin-top: 0px;">
                                <div id="realestatecategoryavatar_img" style="display: inline-block; max-width: 100px; max-height: 100px; overflow: hidden; vertical-align: top; <?php if ($model->avatar) echo 'margin-right: 10px;'; ?>">  
                                ...
                                <div id="realestatecategoryavatar_form" style="display: inline-block;">
...
<script type="text/javascript">
    jQuery(function ($) {
        jQuery('#realestatecategoryavatar_form').ajaxUpload({
            url: '<?php echo Yii::app()->createUrl("/economy/realestateCategories/uploadfile"); ?>',
            name: 'file',
            onSubmit: function () {
            },
            onComplete: function (result) {
                ...
                if (obj.status == '200') {
                    if (obj.data.realurl) {
                        ...
                        if (jQuery('#realestatecategoryavatar_img img').attr('src')) {
                            jQuery('#realestatecategoryvatar_img img').attr('src', obj.data.realurl);
                        } else {
                            jQuery('#realestatecategoryavatar_img').append('<img src="' + obj.data.realurl + '" />');
                        }
                        jQuery('#realestatecategoryavatar_img').css({"margin-right": "10px"});
                    }
                }
            }
        });
    ...
    jQuery(document).ready(function () {
        CKEDITOR.replace("RealEstateCategories_cat_description", {
            height: 400,
