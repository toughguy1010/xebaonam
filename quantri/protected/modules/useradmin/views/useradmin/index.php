...
<div class="widget-box">
    <div class="widget-header">
        ...
        <div class="widget-toolbar no-border">
            <a href="<?php echo Yii::app()->createUrl('/useradmin/useradmin/create'); ?>" class="btn btn-xs btn-primary">
                <i class="icon-plus"></i>
                            ...
                            array(
                                ...
                                'buttons' => array(
                                    'update' => array(
                                        'label' => '',
                                        'imageUrl' => false,
                                        'url' => 'Yii::app()->createUrl("/useradmin/useradmin/update", array("id" => $data->user_id))',
                                    ...
                                    'delete' => array(
                                        'label' => '',
                                        'imageUrl' => false,
                                        'url' => 'Yii::app()->createUrl("/useradmin/useradmin/delete", array("id" => $data->user_id))',
