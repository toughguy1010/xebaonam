...
<div class="row">
    <div class="col-xs-12 no-padding">
        ...
        <div class="profileif">
            ...
            <?php } ?>
            <div class="control-group form-group">
                <?php echo CHtml::label(Yii::t('user', 'permission'), '', array('class' => 'col-sm-2 control-label no-padding-left')); ?>
                <div class="controls col-sm-10">
                    <div class="form-group no-margin-left">
                        ...
                        <div class="listcheck" id="permissionList" style="margin-left: 50px; margin-top: 10px; <?php echo (!$model->permission_limit) ? 'display:none;' : ''; ?>">
                            <?php
                            ...
                            foreach ($permissions as $key => $label) {
                                ...
                                ?>
                                <label class="labelcheckpage">
                                    <input <?php echo ($checked) ? 'checked="checked"' : '' ?> type="checkbox" value="<?php echo $key; ?>" class="checkpage" name="permission[]"> <?php echo $label; ?>
                                </label>
                            <?php } ?>
                        </div>
                        <script type="text/javascript">
                            jQuery(function () {
                                jQuery('#UsersAdmin_permission_limit').on('change', function () {
