        ...
        <?php foreach ($products as $product) { ?>
            <tr>
                <td class="muted center_text">
                    <a href="<?php echo isset($product['link']) ? $product['link'] : '#'; ?>">
                        <img src="<?php echo ClaHost::getImageHost() . $product['avatar_path'] . 's50_50/' . $product['avatar_name']; ?>">
                    </a>
                </td>
                <td>
                    <a href="<?php echo $product['link']; ?>" class="product-name" style="text-decoration: none; font-weight: bold;">
                ...
                <td style="text-align: right;"><?php echo Product::getPriceText(array('price' => $product['product_price'])); ?></td>
                <td style="text-align: right;"><?php echo Product::getTotalPrice(array('price' => $product['product_price']), $product["product_qty"]); ?></td>
            </tr>
        <?php } ?>		  
    </tbody>
</table>
