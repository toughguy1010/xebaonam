...
<div class="container clearfix">
    ...
    <div class="page-list-news page-introduce clearfix">
                    ...
                    <div class="box-news-left">
                        <div class="menu-news-left clearfix">
                            <ul role="tablist" id="myTabs">
                                <li class="active" role="presentation"><a aria-expanded="true" aria-controls="tin-tuc"
                                                                          data-toggle="tab" role="tab" id="tin-tuc-tab"
                                                                          href="#tin-tuc">tin tức</a></li>
                                <li role="presentation"><a aria-controls="video" data-toggle="tab" id="video-tab"
                                                           role="tab" href="#video">video</a></li>
                                <li role="presentation"><a aria-controls="hoi-dap" data-toggle="tab" id="hoi-dap-tab"
                                                           role="tab" href="#hoi-dap">hỏi đáp</a></li>
                                <li role="presentation"><a aria-controls="facebook" data-toggle="tab" id="facebook-tab"
                                                           role="tab" href="#facebook">facebook</a></li>
                            </ul>
                        </div>
                        <div class="cont-menu-left">
                            <div class="tab-content" id="myTabContent">
                                <div aria-labelledby="tin-tuc-tab" id="tin-tuc" class="tab-pane fade in active"
                                     role="tabpanel">
