...
<ul class="row1 homeproduct">
    <li class="top-one productmain product pbodermain pboder">
        <input type="hidden" value="493" name="dataid" class="dataid">
        <a href="<?= $product_top['link'] ?>" class="box-img">
            <img src="<?= ClaHost::getImageHost() . $product_top['avatar_path'] . 's1000_1000/' . $product_top['avatar_name'] ?>" alt="<?= $product_top['name'] ?>">
        </a>
        <div class="num_view2">
            <label>
    ...
    <?php if($products) foreach ($products as $product) { ?>
        <li class="top-s productmain product pbodermain pboder ">
