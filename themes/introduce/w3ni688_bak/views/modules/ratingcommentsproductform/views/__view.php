<p><h2 style="display: inline;padding-right:10px">73 đánh giá Samsung Galaxy J5 Prime</h2><span> | </span>
<button class="btn btn-default" style="overflow: hidden;
width: auto;
border-left: solid 1px #ddd;
vertical-align: middle;
box-sizing: border-box;">Abc
</button></p>

<div class="row">
    <div class="product-customer-rating js-customer-col-4 " style="display: block;">
        <?php
        ...
        <?php if (Yii::app()->user->isGuest) { ?>
            <div class="form-inline">
                <div class="form-group">
                    <?php echo $form->textArea($model, 'comment', array('class' => 'form-control', 'placeholder' => 'Nội dung')); ?>
                    <?php echo $form->error($model, 'comment'); ?>
                </div>
                <div class="form-group">
                    <?php echo $form->textField($model, 'tittle', array('class' => 'form-control', 'style' => '')); ?>
                    <?php echo $form->error($model, 'tittle'); ?>
                    <?php echo $form->textField($model, 'name', array('placeholder' => 'Tên', 'class' => 'form-control', 'required' => 'required')); ?>
