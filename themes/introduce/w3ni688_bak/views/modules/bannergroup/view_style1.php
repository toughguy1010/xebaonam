<?php if ($banners && count($banners)) { ?>
    <div id="slider1_container" style="position: relative; bottom: 0px; left: 0px; width: 800px; height: 354px; background: #fff; overflow: hidden; ">
        <!-- Slides Container -->
        <div u="slides" style="cursor: move; position: absolute; left:0px; top: 0px; width: 800px; height: 354px;
             overflow: hidden;">
             <?php
             foreach ($banners as $banner) {
                ...
                <div>
                    ...
                    <div u="thumb"><img alt="<?php echo $banner['banner_name']; ?>" src="<?php echo $banner['banner_src']; ?>"/></div>
                </div>
            <?php } ?>
        </div>
        <div u="thumbnavigator" class="jssort14" style="left:0px; bottom: 0px; float: left; ">
