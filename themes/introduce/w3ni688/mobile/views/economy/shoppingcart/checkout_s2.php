    ...
    <div class="infouser">
        <div class="areainfo">
            ...
            <div class="right">
                ...
                if ($transportmethod) {
                foreach ($transportmethod

                as $tk => $tinfo) {
                ?>
                <label class="fw-100" for="female1_<?= $tk ?>">
                    <input id="female1_<?= $tk ?>" type="radio" name="Orders[transport_method]"
                           value="<?php echo $tk; ?>" <?php if ($order->transport_method == $tk) echo 'checked="checked"' ?>/>
                    <?php
