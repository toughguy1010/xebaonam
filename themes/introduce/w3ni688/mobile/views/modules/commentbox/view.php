                                ...
                                <div class="user-cmt">
                                    <div class="user-cmt-avat">
                                        <div class="avatar-name-fword" style="">
                                            ...
                                            <?php } else { ?>
                                                <img src="<?php echo Yii::app()->theme->baseUrl ?>/css/img/logo_comment.png"
                ...
                <?php for ($i = 1; $i <= $total_page; $i++) { ?>
                    <li class="page <?php echo ($i === 1) ? 'selected' : '' ?> <?= ($i > 5) ? 'hiden_page' : '' ?> ">
                        <a href="javascript:void(0)"
                           onclick="getCommentPage1(<?php echo (int)$i; ?>, this)"><?php echo $i ?>
                        </a>
                    </li>
                <?php } ?>
                <?php if ($total_page > 5) { ?>
...
<script>
    ...
    function getCommentPage1(page, thisTag) {
