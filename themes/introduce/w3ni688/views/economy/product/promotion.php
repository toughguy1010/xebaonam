                        ...
                        <div class="box-product box-promotion">
                            <div class="box-img img-product img-promotion">
                                <a href="<?php echo $product['link']; ?>" title="<?php echo $product['name'] ?>">
                                    <img src="<?php echo ClaHost::getImageHost() . $product['avatar_path'] . 's600_600/' . $product['avatar_name'] ?>" alt="<?php echo $product['name'] ?>" />
                                </a>
                            </div>
                            ...
                            <a href="<?php echo Yii::app()->createUrl('/economy/shoppingcart/add', array('pid' => $product['id'])); ?>" title="Mua" class="buy-promotion">
                                Mua </a>
                            <a href="<?= Yii::app()->createUrl('installment/installment/index', ['id' => $product['id']]) ?>" title="Trả góp" class="installment-promotion"> Trả góp 0% </a>

                            <?php if ($product['state'] == 1) { ?>
                                <a href="<?php echo $product['link']; ?>" title="còn hàng" class="order-product order-promotion"> còn hàng </a>
                            <?php } ?>
