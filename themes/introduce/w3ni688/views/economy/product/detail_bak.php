            ...
            <div class="cont-top-product-detail clearfix">
                                                        ...
                                                        <?php if ($images && count($images)) { ?>
                                                            <div class="thumb-img">
                                                                <div id="owl-details" class="owl-carousel owl-theme">
                                                                    <a data-zoom-id="magiczoommain<?php echo $color_code ?>" href="<?php echo ClaHost::getImageHost(), $first['path'], $first['name'] ?>" data-image="<?php echo ClaHost::getImageHost(), $first['path'], 's500_500/', $first['name'] ?>"><img src="<?php echo ClaHost::getImageHost(), $first['path'], 's50_50/', $first['name'] ?>" alt="<?php echo $product['name'] ?>" /></a>
                                                                    <?php foreach ($images as $img) { ?>
                                                                        <a data-zoom-id="magiczoommain<?php echo $color_code ?>" href="<?php echo ClaHost::getImageHost(), $img['path'], $img['name'] ?>" data-image="<?php echo ClaHost::getImageHost(), $img['path'], 's500_500/', $img['name'] ?>"><img src="<?php echo ClaHost::getImageHost(), $img['path'], 's50_50/', $img['name'] ?>" alt="<?php echo $product['name'] ?>" /></a>
                                                                    <?php } ?>
                                                                </div>
                                                            </div>
                                                        <?php } ?>
                ...
                <div class="col-lg-6 col-md-12 box-info-detail clearfix">
                    <div class="general-information product-detail-info" id="product-detail-info">
                        <?php
                        if ($product['price'] && $product['price'] > 0 && $product['state'] != 0) {
                        ?>
                            <p class="price-detail" style="padding: 10px 0;border-top: 1px solid rgba(195, 195, 195, .5);border-bottom: 1px solid rgba(195, 195, 195, .5);">
                                <!-- giá -->
                                <label class="price-attr"><?php echo number_format($product['price']); ?></label>
                                <sup>đ</sup>
