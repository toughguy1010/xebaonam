    ...
    <div class="list-albums clearfix">
        <div class="row">
            ...
            if (count($list_album)) {
                ...
                ?>
                <div class="item-album-large item-images col-sm-4">
                    <a class="img" href="<?php echo $first['link']; ?>" title="<?php echo $first['album_name']; ?>">
                ...
                <?php foreach ($list_album as $album) { ?>
                    <div class="item-album-small item-images col-sm-4">
                        <a class="img" href="<?php echo $album['link']; ?>" title="<?php echo $album['album_name']; ?>">
