...
if ($banners && count($banners)) { ?>
    <div class="slider">
        <div id="slider1_container" style="position: relative; top: 0px; left: 0px; width: 1200px; height: 450px; overflow: hidden; ">
            <!-- Loading Screen -->
            ...
            <style>
                ...
                .jssorb05 .av {
                    ...
                    width: 16px;
                    height: 16px;
                    background: url(css/img/b05.png) no-repeat;
                    overflow: hidden;
                    cursor: pointer;
                }
            ...
            <style>
                ...
                .jssora12r {
                    ...
                    height: 46px;
                    cursor: pointer;
                    background: url(css/img/a12.png) no-repeat;
                    overflow: hidden;
                }
            ...
            <!-- Arrow Left -->
            <span u="arrowleft" class="jssora12l" style="top: 210px; left: 0px;">
                                </span>
            <!-- Arrow Right -->
            <span u="arrowright" class="jssora12r" style="top: 210px; right: 0px;">
                                </span>
