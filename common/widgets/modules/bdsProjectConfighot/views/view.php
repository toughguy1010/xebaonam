<?php if ($show_widget_title) { ?>
    <h2 class="title-project wow fadeInUp">
        <a href="javascript:voi(0)"><?php echo $widget_title ?></a>
    </h2>
<?php } ?>
                ...
                <div class="hot-project-img">
                    <a target="_blank" href="<?php echo $project['link'] ?>">
                        <?php if ($project['avatar_path'] && $project['avatar_name']) { ?>
                            <img src="<?php echo ClaHost::getImageHost(), $project['avatar_path'], 's380_380/', $project['avatar_name'] ?>" alt="<?php echo $project['name'] ?>" />
                        <?php } ?>
                    </a>
                </div>
