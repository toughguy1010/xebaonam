<div class="Course-Registration">
    ...
    <div class="form-group w3-form-group">
        <div class="col-xs-12 w3-form-field">
            <?php echo $form->textArea($model, 'message', array('class' => 'form-control w3-form-input input-textarea', 'placeholder' => 'Lời nhắn của bạn')); ?>
    ...
    <div class="w3-form-group form-group">
        <div class=" col-xs-12 w3-form-button">
            <div class="registered-action">
                <button type="button" class="btn btn-primary" onclick="submit_course_register_form();"><span>Đăng ký</span><span class="hiden-mobile"> học ngay </span></button>
            </div>
        </div>
    </div>
