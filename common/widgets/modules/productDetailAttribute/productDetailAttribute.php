...
// Chi tiết sản phẩm
class productDetailAttribute extends WWidget {

    public $product_id = null;
    protected $name = 'productDetailAttribute'; // name of widget
    ...
    public function init() {
        ...
        // Load config
        $config_productdetail = new config_productDetailAttribute('', array('page_widget_id' => $this->page_widget_id));
