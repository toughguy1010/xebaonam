        ...
        foreach ($events as $event) {
            ...
            <div class="event-item">
                ...
                <div class="event-info">
                    ...
                    <div class="item-time"><?php echo date('d/m/Y', strtotime($event['start_date'])); ?></div>
                    ...
                    <div class="item-actionbox clearfix">
                        ...
                        <a href="<?php echo $event['link']; ?>" class="item-sign-up item-sign-litsk"><?php echo yii::t('event', 'detail') ?></a>
                    </div>
                </div>
            </div>
        <?php }
