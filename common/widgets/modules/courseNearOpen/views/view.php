<div class="opening">
    ...
    <?php if (count($courses)) { ?>
        <div id="slider2_container" style="position: relative; width: 690px;height: 340px; overflow: hidden;">

            <!-- Slides Container -->
            <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 690px; height: 340px; overflow: hidden;">
                <?php foreach ($courses as $course) { ?>
                    <div>
                        <a u=image href="<?php echo $course['link'] ?>">
                            <img src="<?php echo ClaHost::getImageHost().$course['image_path'].'s700_0/'.$course['image_name'] ?>" alt="<?php echo $course['name'] ?>">
                        </a>
                        <div u=caption t="*" class="captionOrange"  style="position:absolute; left:20px; top: 30px; width:300px; height:30px;  background-color: rgba(0, 0, 0, 0.37); color:#fff; padding-left:20px; line-height:30px;"> 
...
<script>
    jQuery(document).ready(function ($) {
        ...
        function ScaleSlider() {
            ...
            if (parentWidth)
                jssor_slider1.$ScaleWidth(Math.min(parentWidth, 690));
            else
