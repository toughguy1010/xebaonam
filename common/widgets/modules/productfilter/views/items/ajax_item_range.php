        ...
        <div class="box-title-animation-sp-sp clearfix">
            ...
            <div class="view-list-animation-sp-sp">
                <div class="box-input-animation">
                    <span><input type="text" name="<?php echo $nmin;?>" class="op-ft-range" id="<?php echo $nmin;?>" value="<?php echo Yii::app()->request->getParam($nmin,"");?>" class="animation-last"/></span>
                    <span><input type="text" name="<?php echo $nmax;?>" class="op-ft-range" id="<?php echo $nmax;?>" value="<?php echo Yii::app()->request->getParam($nmax,"");?>" class="animation-child" /></span>
    ...
    $(function () {
        ...
        $("#slider-range-"+attid).slider({
            ...
            slide: function (event, ui) {
                $("#"+nmin).val(ui.values[ 0 ]);
                $("#"+nmax).val(ui.values[ 1 ]);
        ...
        $("#"+nmax).val($("#slider-range-"+attid).slider("values", 1));
    });               
</script>