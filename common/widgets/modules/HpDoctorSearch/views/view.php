<div class="form-search-inline">
    <form action="<?php echo Yii::app()->createUrl('hospital/hpDoctor') ?>" method="GET" class="form-inline" role="form">
        ...
        <?php if (isset($faculties) && $faculties) { ?>
            <div class="form-group">
                <select name="falcalty" class="form-control">
        ...
        <div class="form-group">
            <select name="gender" class="form-control">
                ...
                <option <?= $gender == ActiveRecord::STATUS_ACTIVED ? 'selected' : '' ?> value="<?php echo ActiveRecord::STATUS_ACTIVED ?>">Nam</option>
                <option <?= $gender == ActiveRecord::STATUS_DEACTIVED ? 'selected' : '' ?> value="<?php echo ActiveRecord::STATUS_DEACTIVED ?>">Nữ</option>
            </select>
        </div>
