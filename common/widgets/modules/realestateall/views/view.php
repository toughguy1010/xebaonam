        ...
        <?php foreach ($list_realestate as $realestate) { ?>
            <div class="ire">
                ...
                <div class="box-info-real-estate">
                    <h3>
                        <a class="<?php echo $realestate['type'] == 2 ? 'internal' : 'normal' ?>" href="<?php echo $realestate['link'] ?>" title="<?php echo $realestate['type'] == 2 ? Yii::t('realestate', 'realestate_internal') : Yii::t('realestate', 'realestate_normal'); ?>"><?php echo $realestate['type'] == ActiveRecord::TYPE_INTERNAL ? '[NB]' : '' ?> <?php echo $realestate['name'] ?></a>
                    </h3>
