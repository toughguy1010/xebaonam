    ...
    var DEFAULT_SETTINGS = {
        ...
        resultsFormatter: function(item) {
            ...
            if (typeof item.avatar !== 'undefined') {
                ...
                htmlShow = htmlShow + '<div class="token_description_box" style="margin-left: 35px;"><p style="margin-top: 0px;">' + item[this.propertyToSearch] + '</p>';
                htmlShow = htmlShow + '<p style="color: #555;  font: 10pt Arial,Helvetica,sans-serif;">' + item.description + '</p></div><div style="clear: both"></div>';
            } else {
                htmlShow = htmlShow + '<p>' + item[this.propertyToSearch] + '</p>';
            }
