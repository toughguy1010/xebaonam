...
/**
 * This is the model class for table "theme_categories".
 *
 * The followings are the available columns in table 'theme_categories':
 ...
 */
class ThemeCategories extends ActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('site_id, cat_parent, cat_name, cat_order, status', 'required'),
            ...
            array('cat_id, site_id, cat_parent, cat_name, alias, cat_order, cat_description, cat_countchild, image_path, image_name, status, created_time, modified_time, showinhome, meta_keywords, meta_description, meta_title, avatar', 'safe'),
        );
    }
     ...
     * @return ThemeCategories the static model class
     */
