...
/**
 * This is the model class for table "theme_images".
 *
 * The followings are the available columns in table 'theme_images':
 ...
 */
class ThemeImages extends ActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('img_id, theme_id, name, path, display_name, description, alias, site_id, user_id, height, width, created_time, modified_time, resizes', 'safe'),
		);
	}
	 ...
	 * @return ThemeImages the static model class
	 */
