...
/**
 * This is the model class for table "hp_education".
 *
 * The followings are the available columns in table 'hp_education':
 * @property string $id
 ...
 */
class HpEducation extends ActiveRecord {
...
//        $criteria->compare('order', $this->order, true);
     ...
     * @return HpEducation the static model class
     */
