...
/**
 * This is the model class for table "bds_comforts".
 *
 * The followings are the available columns in table 'bds_comforts':
 * @property string $id
 ...
 */
class BdsComforts extends ActiveRecord {
    ...
    public function attributeLabels() {
        return array(
            'id' => 'ID',
            'name' => Yii::t('bds_comforts', 'name'),
            'status' => Yii::t('bds_common', 'status'),
            'showinlist' => Yii::t('bds_comforts', 'showinlist'),
     ...
     * @return BdsComforts the static model class
     */
    ...
    public static function getAllComforts() {
