...
/**
 * This is the model class for table "bds_environment".
 *
 * The followings are the available columns in table 'bds_environment':
 * @property string $id
 ...
 */
class BdsEnvironment extends ActiveRecord {
    ...
    public function attributeLabels() {
        return array(
            'id' => 'ID',
            'name' => Yii::t('bds_environment', 'name'),
            'status' => Yii::t('bds_common', 'status'),
            'showinlist' => Yii::t('bds_environment', 'showinlist'),
     ...
     * @return BdsEnvironment the static model class
     */
