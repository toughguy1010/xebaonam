...
/**
 * This is the model class for table "bds_maps".
 *
 * The followings are the available columns in table 'bds_maps':
 ...
 */
class BdsMaps extends ActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('real_estate_id, latlng, name, address, email, phone, site_id', 'safe', 'on' => 'search'),
        );
    }
     ...
     * @return BdsMaps the static model class
     */
