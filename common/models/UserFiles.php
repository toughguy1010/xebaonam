...
class UserFiles extends ActiveRecord {
    ...
    //default file size limit. default value : 50MB
    CONST LIMIT_SIZE = 50000000; //byte
    ...
    public function rules() {
        ...
        return array(
            ...
            array('id, user_id, site_id, name, path, description, display_name, extension, size, created_time, modified_time, file_src', 'safe', 'on' => 'search'),
        );
    }
