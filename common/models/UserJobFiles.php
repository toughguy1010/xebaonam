...
/**
 * This is the model class for table "user_job_files".
 *
 * The followings are the available columns in table 'user_job_files':
 * @property string $id
 ...
 */
class UserJobFiles extends ActiveRecord
{
    ...
    const TYPE_JOB_FILE = 0;
    const TYPE_PROFILE_FILE = 1;
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('user_id, site_id, created_time, modified_time, type', 'numerical', 'integerOnly' => true),
            ...
            array('id, user_id, site_id, name, path, description, display_name, extension, size, created_time, modified_time, file_src, type', 'safe', 'on' => 'search'),
        );
    }
     ...
     * @return UserJobFiles the static model class
     */
