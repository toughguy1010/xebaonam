 ...
 * @author hungtm
 */
class config_courseNearOpen extends ConfigWidget {

    public $limit = 1;
    public $show_via_hot_order = null;
    public $use_new_schedule = false;

    public function rules() {
        return array_merge(array(
            array('limit', 'required'),
            array('show_via_hot_order,use_new_schedule', 'numerical'),
    ...
    public function buildConfigAttributes() {
        $data = array_merge(parent::buildConfigAttributes(), array(
            'config_data' => json_encode(array(
                ...
                'use_new_schedule' => $this->use_new_schedule,
            ))
        ));
        return $data;
    }
