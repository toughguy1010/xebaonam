 ...
 */
class AffiliateConfig extends ActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('site_id, cookie_expire', 'required'),
            ...
            array('site_id, cookie_expire, commission_order, commission_click, change_phone, status, created_time, modified_time', 'safe', 'on' => 'search'),
        );
    }
