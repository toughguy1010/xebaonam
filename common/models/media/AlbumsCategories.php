 ...
 */
class AlbumsCategories extends ActiveRecord {
    ...
    public function tableName() {
        return $this->getTableName('albums_categories');
    }
    ...
    static function getAllCategory($site_id = null) {
        ...
        $categories = Yii::app()->db->createCommand()->select('*')->from(ClaTable::getTable('albums_categories'))
