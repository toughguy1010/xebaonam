...
/**
 * This is the model class for table "job_apply_files".
 *
 * The followings are the available columns in table 'job_apply_files':
 * @property string $id
 ...
 */
class JobApplyFiles extends ActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('job_apply_id, user_id, site_id, created_time, modified_time', 'numerical', 'integerOnly' => true),
            ...
            array('id, job_apply_id, user_id, site_id, name, path, description, display_name, extension, size, created_time, modified_time, file_src', 'safe', 'on' => 'search'),
        );
    }
     ...
     * @return JobApplyFiles the static model class
     */
