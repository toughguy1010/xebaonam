...
/**
 * This is the model class for table "se_faculty".
 *
 * The followings are the available columns in table 'se_faculty':
 * @property string $id
 ...
 */
class SeFaculty extends ActiveRecord {
...
//        $criteria->compare('order', $this->order, true);
     ...
     * @return SeFaculty the static model class
     */
