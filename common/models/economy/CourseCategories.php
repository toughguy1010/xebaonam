...
class CourseCategories extends ActiveRecord {
    ...
    public function tableName() {
        return $this->getTableName('edu_course_categories');
    }
    ...
    public static function getCategoryInHome($options = array()) {
        ...
        foreach ($categories as $cat) {
            ...
            $results[$cat['cat_id']]['link'] = Yii::app()->createUrl('economy/course/category', array('id' => $cat['cat_id'], 'alias' => $cat['alias']));
            $results[$cat['cat_id']]['link2'] = Yii::app()->createUrl('economy/course/categoryunlimit', array('id' => $cat['cat_id'], 'alias' => $cat['alias']));
        }
        return $results;
    }
