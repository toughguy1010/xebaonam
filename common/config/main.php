...
return array(
    ...
    'components' => array(
        'db' => array(
            'connectionString' => 'mysql:host=127.0.0.1;dbname=sql_xebaonam_nan',
            'emulatePrepare' => true,
            'username' => 'sql_xebaonam_nan',
            'password' => '6dBHMrnxsXTwdnts',
            'charset' => 'utf8',
...
//                )
        ...
        'mailer' => array(
            'class' => 'W3NPHPMailer',
            'Host' => 'smtp.gmail.com',
            'Username' => 'nanowebvn.mail@gmail.com',
            'Password' => 'mwkzetkmyuyzispx',
            'Port' => 465,
            'SMTPSecure' => 'ssl',
        ),
        'smser' => array(
