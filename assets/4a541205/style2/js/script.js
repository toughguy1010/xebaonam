...
(function($, window, undefined) {
    ...
    var iView = function(el, options) {
        ...
        iv.slides.each(function(i) {
            ...
            if (slide.data("iview:thumbnail"))
                iv.defs.images.push(slide.data("iview:thumbnail"));
        ...
        iv.sliderContent.bind('iView:goSlide', function(event, slide) {
            if (iv.defs.lock || iv.defs.slide == slide)
                return false;
    ...
    iView.prototype = {
        ...
        startSlider: function() {
            ...
            if (iv.options.directionNav) {
                ...
                $(document).on('click','a.iview-prevNav', iv.sliderContent, function() {
                    if (iv.defs.lock)
                        return false;
                    iv.cleanTimer();
                    iv.defs.slide -= 2;
                ...
                $(document).on('click','a.iview-nextNav', iv.sliderContent, function() {
                    if (iv.defs.lock)
                        return false;
                    iv.cleanTimer();
                    iv.goTo('next');
            ...
            if (iv.options.controlNav) {
                var iviewControl = '<div class="iview-controlNav">',
                        iviewTooltip = '';
                if (!iv.options.directionNav && iv.options.controlNavNextPrev)
                    iviewControl += '<a class="iview-controlPrevNav" title="' + iv.options.previousLabel + '">' + iv.options.previousLabel + '</a>';
                ...
                for (var i = 0; i < iv.defs.total; i++) {
                    ...
                    if (iv.options.controlNavThumbs) {
                        ...
                        if (iv.options.controlNavTooltip)
                ...
                iviewControl += '</ul></div>';
                if (!iv.options.directionNav && iv.options.controlNavNextPrev)
                    iviewControl += '<a class="iview-controlNextNav" title="' + iv.options.nextLabel + '">' + iv.options.nextLabel + '</a>';
                iviewControl += '</div>';

                if (!iv.options.controlNavThumbs && iv.options.controlNavTooltip)
                    iviewControl += '<div id="iview-tooltip"><div class="holder"><div class="container">' + iviewTooltip + '</div></div></div>';
                ...
                $(document).on('click','a.iview-controlPrevNav', iv.sliderContent, function() {
                    if (iv.defs.lock)
                        return false;
                    iv.cleanTimer();
                    iv.defs.slide -= 2;
                ...
                $(document).on('click','a.iview-controlNextNav', iv.sliderContent, function() {
                    if (iv.defs.lock)
                        return false;
                    iv.cleanTimer();
                    iv.goTo('next');
                ...
                $(document).on('click','.iview-controlNav a.iview-control', iv.sliderContent, function() {
                    if (iv.defs.lock)
                        return false;
                    if ($(this).hasClass('active'))
                        return false;
        ...
        setCaption: function() {
            ...
            captions.each(function(i) {
                ...
                if (x == "center")
                    x = ((iv.defs.width / 2) - (oW / 2));
                if (y == "center")
                    y = ((iv.defs.height / 2) - (oH / 2));
        ...
        addBlocks: function() {
            ...
            for (var rows = 0; rows < iv.options.blockRows; rows++) {
                for (var columns = 0; columns < iv.options.blockCols; columns++) {
                    ...
                    if (columns == iv.options.blockCols - 1)
                        width = (iv.slider.width() - (blockWidth * columns)) + 'px';
        ...
        runTransition: function(fx) {
            ...
            switch (fx) {
                ...
                case 'strip-up-left':
                    ...
                    if (fx == 'strip-up-left')
                        strips = $('.iview-strip', iv.slider).reverse();
                ...
                case 'top-curtain':
                case 'bottom-curtain':
                    if (fx == 'left-curtain' || fx == 'right-curtain')
                        iv.addStrips();
                    else
                        iv.addStrips(true);
                    var timeDelay = 0,
                    ...
                    if (fx == 'right-curtain' || fx == 'bottom-curtain')
                        strips = $('.iview-strip', iv.slider).reverse();
                ...
                case 'strip-bottom-fade':
                    if (fx == 'strip-left-fade' || fx == 'strip-right-fade')
                        iv.addStrips();
                    else
                        iv.addStrips(true);
                    var timeDelay = 0,
                    ...
                    if (fx == 'strip-right-fade' || fx == 'strip-bottom-fade')
                        strips = $('.iview-strip', iv.slider).reverse();
                ...
                case 'zigzag-drop-bottom':
                    ...
                    if (fx == 'zigzag-bottom' || fx == 'zigzag-grow-bottom' || fx == 'zigzag-drop-bottom')
                        blockToArr.reverse();
                    ...
                    blocks.each(function(i) {
                        ...
                        if (fx == 'zigzag-grow-top' || fx == 'zigzag-grow-bottom')
                            block.width(0).height(0);
                        else if (fx == 'zigzag-drop-top' || fx == 'zigzag-drop-bottom')
                            block.css({
                                top: '-=50'
                            });
                ...
                case 'block-drop-random':
                    ...
                    blocks.each(function(i) {
                        var block = $(this),
                                ...
                                w = block.width(),
                                top = block.css('top');
                        if (fx == 'block-expand-random')
                            block.width(0).height(0);
                        if (fx == 'block-drop-random')
                            block.css({
                                top: '-=50'
                            });
        ...
        disableSelection: function(target) {
            ...
            else if (typeof target.style.userSelect != "undefined")
