...
<div class="top-detail">
    <div class="header-top-detail">
        <div class="list-content-body">
            <h3 class="list-content-title"> <a href="javascript:void(0)" title="<?php echo $tour['name'] ?>"><?php echo $tour['name'] ?> </a> </h3>
        ...
        <div class="box-detail-hotel clearfix" style="padding: 10px 0px;">
            ...
            <div class="col-xs-4">
                <div class="price-tour">
                    <?php if ($tour['price'] > 0) { ?>
                        <div class="price">
                            <label>Giá Tour:</label> <span><?php echo number_format($tour['price'], 0, '', '.'); ?> đ</span>
                        </div>
                    <?php } ?>
                    <?php if ($tour['price_market'] > 0) { ?>
                        <div class="price-market">
                            <label>Giá chưa khuyến mại:</label> <span><?php echo number_format($tour['price_market'], 0, '', '.'); ?> đ</span>
                        </div>
                    <?php } ?>
                </div>
                <form action="<?php echo Yii::app()->createUrl('tour/booking/bookingTour'); ?>" id="form_booking_tour" method="POST">
