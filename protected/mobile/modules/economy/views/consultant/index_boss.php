...
<div class="widget-box">
    <div class="widget-header">
        <h4>
            <?php echo Yii::t('realestate', 'boss'); ?>
        </h4>

        <div class="widget-toolbar no-border">
            <a href="<?php echo Yii::app()->createUrl('economy/consultant/createBoss', array('id' => ClaCategory::CATEGORY_ROOT)); ?>" class="btn btn-xs btn-primary" style="margin-right: 20px;">
                <i class="icon-plus"></i>
                <?php echo Yii::t('event', 'consultant_boss_add_new'); ?>
            </a>
<!--            <a href="--><?php //echo Yii::app()->createUrl('economy/consultant/delall'); ?><!--" class="btn btn-xs btn-danger delAllinGrid" grid="news-categories-grid">-->
                    ...
                    array(
                        ...
                        'buttons' => array(
                            'update' => array(
                                'label' => '',
                                'imageUrl' => false,
                                'url' => 'Yii::app()->createUrl("economy/consultant/updateBoss", array("id" => $data["id"]))',
