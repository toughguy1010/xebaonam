    ...
    <div class="container">
        <div class="info-section">
            <div class="" style="text-align: center;">
                <h2><?= Yii::t('rent', 'rent_sucsess') ?></h2>
                <p><?= Yii::t('rent', 'notice_sucsess') ?></p>
            </div>
            <div class="info">
                <div class="infor-order-thuedo">
                    <div class="title">
                        <h2><?= Yii::t('rent', 'customer_infomation') ?></h2>
                    </div>
                    <div class="ctn-infor-order-thuedo" style="text-align: center">
                        ...
                        <?php foreach ($items as $key => $val) { ?>
                            <div class="ctn-infor-order-thuedo">
                                ...
                                <div class="item-info">
                                    ...
                                    <p style="font-size: 11px"><?= Yii::t('rent', 'deposit_notice') ?></p>
                                </div>
                                ...
                                <div class="total-price-info">
                                    <p>
                                        Tổng
                                        tiền: <?= HtmlFormat::money_format($modelOrderRent->total_price) . ' VND' ?>
                                    </p>
                                </div>
                            </div>
                        <?php } ?>
