                                        ...
                                        <div class="form-infor-user">
                                            <div class="panel-body">
                                                ...
                                                <div class="form-group required">
                                                    ...
                                                    <div class="controls ">
                                                        <?php echo $form->dropDownList($billing, 'district', array(), array('class' => '', 'style' => '')); ?>
                                    ...
                                    <div class="form-infor-user">
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group required">
                                                ...
                                                <div class="controls ">
                                                    <?php echo $form->dropDownList($shipping, 'district', array(), array('class' => '', 'style' => '')); ?>
                    ...
                    <div class="border-payment">
                        ...
                        <div class="total-order">
                            ...
                            <p id="money_ship"><?= Yii::t('shoppingcart', 'money_ship') ?> 
                                <span>0 đ</span>
                                <input type="hidden" id="money_ship_input" />
                            </p>
                            <h3>
                                <p id="money_total"><?= Yii::t('shoppingcart', 'total') ?> 
                                    <span><?php echo number_format($shoppingCart->getTotalPriceDiscount(), 0, '', '.'); ?> đ</span>
                                    <input type="hidden" id="money_total_input" />
                                </p>
                            </h3>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    function getdiscount() {
        ...
        function (data) {
            if (data.code == 200) {
                var sub_total = $('#money_sub_total_input').val();
                var ship = $('#money_ship_input').val();
                var discount_value = 0;
                var couponvalue = 0;
                $('#money_discount span').html(data.totalDiscount);
                $('#money_total span').html(data.totalRemain);
            } else {
                alert(data.msg);
            }
        }
