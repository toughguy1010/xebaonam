<div class="form" style="margin: 10px;">
    ...
    <div class="form-group">
        <?php echo $form->labelEx($model, 'priceFilter', array('class' => 'col-sm-3 control-label')); ?>
        <div class="col-sm-9">
            <?php echo $form->checkBox($model, 'priceFilter'); ?>
            <?php echo $form->error($model, 'priceFilter'); ?>
        </div>
    </div>
    <div class="form-group">
        <?php echo $form->labelEx($model, 'showQuantity', array('class' => 'col-sm-3 control-label')); ?>
        <div class="col-sm-9">
            <?php echo $form->checkBox($model, 'showQuantity'); ?>
            <?php echo $form->error($model, 'showQuantity'); ?>
        </div>
    </div>
    <div class="form-group">
