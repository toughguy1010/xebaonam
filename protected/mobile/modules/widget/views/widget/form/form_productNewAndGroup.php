<div class="form" style="margin: 10px;">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <?php echo $form->dropDownList($model, 'group_id', ProductGroups::getProductGroupArr(), array('class' => 'form-control', 'style' => 'width: 100%;')); ?>
    ...
    <div class="form-group">
        <?php echo $form->labelEx($model, 'show_group_in_home', array('class' => 'col-sm-3 control-label')); ?>
        <div class="col-sm-9">
            <?php echo $form->checkBox($model, 'show_group_in_home'); ?>
        </div>
    </div>
    <div class="form-group">
