<div class="form" style="margin: 10px;">
    ...
    <!--        <div class="col-sm-9">-->
    <!--            --><?php //echo $form->dropDownList($model, 'type', ClaCategory::getCategoryType(), array('class' => 'form-control', 'style' => 'width: 100%;')); ?>
    ...
    <div class="form-group">
        <?php echo $form->labelEx($model, 'show_container_product', array('class' => 'col-sm-3 control-label')); ?>
        <div class="col-sm-9">
            <?php echo $form->checkBox($model, 'show_container_product'); ?>
        </div>
    </div>
    <div class="form-group">
