<div class="form" style="margin: 10px;">
    ...
    <div class="form-group">
        <?php echo $form->labelEx($model, 'yahoos', array('class' => 'col-sm-3 control-label')); ?>
        <div class="col-sm-9">
            <?php echo $form->textField($model, 'yahoos', array('class' => 'form-control', 'style' => 'width: 100%;', 'placeholder' => 'Mỗi nick yahoo cách nhau bởi dấu phẩy(,)')); ?>
            <?php echo $form->error($model, 'yahoos'); ?>
        </div>
    </div>
    <div class="form-group">
