<div class="form" style="margin: 10px;">
    ...
    <div class="form-group">
        <?php echo $form->labelEx($model, 'most_view', array('class' => 'col-sm-3 control-label')); ?>
        <div class="col-sm-9">
            <?php echo $form->checkBox($model, 'most_view'); ?>
        </div>
    </div>
    <div class="form-group">
        <?php echo $form->labelEx($model, 'just_buy', array('class' => 'col-sm-3 control-label')); ?>
        <div class="col-sm-9">
            <?php echo $form->checkBox($model, 'just_buy'); ?>
        </div>
    </div>
    <div class="form-group">
