<div class="form" style="margin: 10px;">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <?php echo $form->textField($model, 'width', array('class' => 'form-control', 'style' => 'width: 100%;')); ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <?php echo $form->textField($model, 'height', array('class' => 'form-control', 'style' => 'width: 100%;')); ?>
