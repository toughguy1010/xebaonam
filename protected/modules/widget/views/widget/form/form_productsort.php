<div class="form" style="margin: 10px;">
    ...
    <div class="form-group">
        <?php echo $form->labelEx($model, 'selectedDefault', array('class' => 'col-sm-3 control-label')); ?>
        <div class="col-sm-9">
            <?php echo $form->dropDownList($model, 'selectedDefault', $model->getPageOptions(), array('class' => 'form-control', 'style' => 'width: 100%;')); ?>
            <?php echo $form->error($model, 'selectedDefault'); ?>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <?php echo $form->labelEx($model, 'afterText', array('class' => 'col-sm-3 control-label')); ?>
        <div class="col-sm-9">
            <?php echo $form->textField($model, 'afterText', array('class' => 'form-control ckeditor', 'style' => 'width: 100%;')); ?>
            <?php echo $form->error($model, 'afterText'); ?>
        </div>
    </div>
    <div class="form-group">
