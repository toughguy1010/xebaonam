...
$option = TourHotel::getAllhotelsOption();
?>
<div class="form" style="margin: 10px;">
    ...
    <div class="form-group">
        <?php echo $form->labelEx($model, 'hotel_id', array('class' => 'col-sm-3 control-label')); ?>
        <div class="col-sm-9">
            <?php echo $form->dropDownList($model, 'hotel_id', $option, array('class' => 'form-control', 'style' => 'width: 100%;')); ?>
    ...
    <div class="form-group">
        <?php echo $form->labelEx($model, 'ishot', array('class' => 'col-sm-3 control-label')); ?>
        <div class="col-sm-9">
            <?php echo $form->checkBox($model, 'ishot'); ?>
        </div>
    </div>
    <div class="form-group">
        <?php echo $form->labelEx($model, 'paginate', array('class' => 'col-sm-3 control-label')); ?>
        <div class="col-sm-9">
            <?php echo $form->checkBox($model, 'paginate'); ?>
        </div>
    </div>
    <div class="form-group">
