<div class="form" style="margin: 10px;">
    ...
    <div class="form-group">
        <?php echo $form->labelEx($model, 'popup_id', array('class' => 'col-sm-3 control-label')); ?>
        <div class="col-sm-9">
            <?php echo $form->dropDownList($model, 'popup_id', (['0' => 'Ngẫu nhiên tất cả']+ PopupRegisterProducts::getPopupArr()), array('class' => 'form-control', 'style' => 'width: 100%;')); ?>
            <?php echo $form->error($model, 'popup_id'); ?>
        </div>
    </div>
    <div class="form-group">
