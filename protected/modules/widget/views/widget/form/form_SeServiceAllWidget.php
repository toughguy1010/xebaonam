<div class="form" style="margin: 10px;">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <?php echo $form->textField($model, 'view', array('class' => 'form-control', 'style' => 'width: 100%;')); ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <?php echo $form->dropDownList($model, 'style', SeServices::arrayStyle(), array('class' => 'form-control', 'style' => 'width: 100%;')); ?>
