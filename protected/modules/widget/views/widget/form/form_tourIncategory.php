...
<div class="form" style="margin: 10px;">
    ...
    <div class="form-group">
        <?php echo $form->labelEx($model, 'tour_hot', array('class' => 'col-sm-3 control-label')); ?>
        <div class="col-sm-9">
            <?php echo $form->checkBox($model, 'tour_hot'); ?>
        </div>
    </div>
    <!--viet-->
    <!--Lấy danh danh mục và tin tức nằm trong danh mục-->
    <div class="form-group">
        <?php echo $form->labelEx($model, 'Get child cat tour', array('class' => 'col-sm-3 control-label')); ?>
        <div class="col-sm-9">
            <?php echo $form->checkBox($model, 'tour_in_cate'); ?>
        </div>
    </div>
    <div class="form-group">
