<div class="form" style="margin: 10px;">
    ...
    <div class="form-group">
        <?php echo $form->labelEx($model, 'show_via_hot_order', array('class' => 'col-sm-3 control-label')); ?>
        <div class="col-sm-9">
            <?php echo $form->checkBox($model, 'show_via_hot_order'); ?>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <?php echo $form->labelEx($model, 'use_new_schedule', array('class' => 'col-sm-3 control-label')); ?>
        <div class="col-sm-9">
            <?php echo $form->checkBox($model, 'use_new_schedule'); ?>
        </div>
    </div>
    <div class="form-group">
