<div class="form" style="margin: 10px;">
    ...
    <div class="form-group">
        <?php echo $form->labelEx($model, 'page_id', array('class' => 'col-sm-3 control-label')); ?>
        <div class="col-sm-9">
            <?php echo $form->dropDownList($model, 'page_id', CategoryPage::getPageContentArr(), array('class' => 'form-control', 'style' => 'width: 100%;')); ?>
