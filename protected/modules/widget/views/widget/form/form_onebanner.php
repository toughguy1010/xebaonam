<div class="form" style="margin: 10px;">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <?php echo $form->textField($model, 'widget_title', array('class' => 'form-control', 'style' => 'width: 100%;')); ?>
            <?php echo $form->error($model, 'widget_title'); ?>
        </div>
    </div>
    <div class="form-group">
        <?php echo $form->labelEx($model, 'banner_id', array('class' => 'col-sm-3 control-label')); ?>
        <div class="col-sm-9">
            <?php echo $form->dropDownList($model, 'banner_id', Banners::getBannerArr(), array('class' => 'form-control', 'style' => 'width: 100%;')); ?>
