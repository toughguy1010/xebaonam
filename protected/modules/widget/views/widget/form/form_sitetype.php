<div class="form" style="margin: 10px;">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <?php echo $form->dropDownList($model, 'type', ClaSite::getSiteTypes(), array('class' => 'form-control', 'style' => 'width: 100%;')); ?>
            <?php echo $form->error($model, 'type'); ?>
        </div>
    </div>
    <div class="form-group">
        <?php echo $form->labelEx($model, 'order_rank', array('class' => 'col-sm-3 control-label')); ?>
        <div class="col-sm-9">
            <?php echo $form->checkBox($model, 'order_rank'); ?>
        </div>
    </div>
    <div class="form-group">
