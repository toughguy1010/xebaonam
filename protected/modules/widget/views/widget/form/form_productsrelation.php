<div class="form" style="margin: 10px;">
    ...
    <div class="form-group">
        <?php echo $form->labelEx($model, 'fromParent', array('class' => 'col-sm-3 control-label')); ?>
        <div class="col-sm-9">
            <?php echo $form->checkBox($model, 'fromParent'); ?>
        </div>
    </div>
    <div class="form-group">
        <?php echo $form->labelEx($model, 'fromManufacture', array('class' => 'col-sm-3 control-label')); ?>
        <div class="col-sm-9">
            <?php echo $form->checkBox($model, 'fromManufacture'); ?>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <?php echo $form->labelEx($model, 'showProductDesc', array('class' => 'col-sm-3 control-label')); ?>
        <div class="col-sm-9">
            <?php echo $form->checkBox($model, 'showProductDesc'); ?>
        </div>
    </div>
    <div class="form-group">
