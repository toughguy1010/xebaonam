<div class="form" style="margin: 10px;">
    ...
    <div class="form-group">
        <?php echo $form->labelEx($model, 'help_text', array('class' => 'col-sm-3 control-label')); ?>
        <div class="col-sm-9">
            <?php echo $form->textField($model, 'help_text', array('class' => 'form-control ckeditor', 'style' => 'width: 100%;')); ?>
            <?php echo $form->error($model, 'help_text'); ?>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <?php echo $form->labelEx($model, 'select_all', array('class' => 'col-sm-3 control-label')); ?>
        <div class="col-sm-9">
            <?php echo $form->checkBox($model, 'select_all'); ?>
        </div>
    </div>
    <div class="form-group">
