<div class="form" style="margin: 10px;">
    ...
    <div class="form-group">
        <?php echo $form->labelEx($model, 'timeDelay', array('class' => 'col-sm-3 control-label')); ?>
        <div class="col-sm-9">
            <?php echo $form->textField($model, 'timeDelay', array('class' => 'form-control', 'style' => 'width: 100%;')); ?>
            <?php echo $form->error($model, 'timeDelay'); ?>
        </div>
    </div>
    <div class="form-group">
        <?php echo $form->labelEx($model, 'style', array('class' => 'col-sm-3 control-label')); ?>
        <div class="col-sm-9">
            <?php echo $form->dropDownList($model, 'style', $model->getListStyleArr(), array('class' => 'form-control', 'style' => 'width: 100%;')); ?>
    ...
    <div class="form-group">
        <?php echo $form->labelEx($model, 'disable_js_default', array('class' => 'col-sm-3 control-label')); ?>
        <div class="col-sm-9">
            <?php echo $form->checkBox($model, 'disable_js_default'); ?>
        </div>
    </div>
    <div class="form-group">
