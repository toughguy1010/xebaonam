<?php if ($hotel) { ?>
    <div class="reservation-in">
        <div class="back-page">
            <a href="<?php echo Yii::app()->createUrl('tour/tourHotel/detail', array('id' => $hotel['id'], 'alias' => $hotel['alias'])) ?>"><?php echo Yii::t('tour_booking', 'return_hotel') ?></a>
        </div>
        <div class="cont">
            <?php
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="contact-info-in">
                        <div class="title-steps">
                            <h3><?php echo Yii::t('tour_booking', 'contact_info'); ?></h3>
                ...
                <div class="col-sm-5">
                    <div class="booking-information">
                        <div class="title-steps">
                            <h3><?php echo Yii::t('tour_booking', 'info_booking_room') ?></h3>
                            <div class="icon-steps">
                                <h4>2</h4>
                            </div>
                        </div>
                        <div class="cont-booking-information">
                            ...
                            <div class="adress-hotel">
                                <p><span><?php echo Yii::t('tour_booking', 'address') ?>:</span> <?php echo implode(' - ', array($hotel['ward_name'], $hotel['district_name'], $hotel['province_name'])); ?></p>
                            </div>
                            <div class="date-room">
                                <p><span class="title-date"><?php echo Yii::t('tour_booking', 'checking_in') ?>: </span><span class="cont-date">  <?php echo $checking_in ?></span></p>
                                <p><span class="title-date"><?php echo Yii::t('tour_booking', 'checking_out') ?>: </span><span class="cont-date">  <?php echo $checking_out ?></span></p>
                            </div>
                            <div class="booking_bill">
                                <h2><?php echo Yii::t('tour_booking', 'info_pay') ?></h2>
                                <?php
                                $i = 0;
                                $totals_price = 0;
                                foreach ($rooms as $room) {
                                    ...
                                    <div class="wap_bill">
                                        <table>
                                            <tbody>
                                                <tr>
                                                    <td class="w_60">
                                                        <span class="numberRooms"><?php echo $room['qty'] ?></span> <?php echo Yii::t('tour_booking', 'room') ?>                                       
                                                    </td>
                                                    <td class="w_10">x</td>
                                                    <td class="w_80 ">
                                                    ...
                                                    <td class="w_10">x</td>
                                                    <td class="w_50 numberNights"><?php echo $room['count_night']; ?> <?php echo Yii::t('tour_booking', 'night') ?></td>
                                                    <td class="w_10">=</td>
                                                    <td align="right">
                                ...
                                ?>
                                <p class="total_money">
                                    <?php echo Yii::t('tour_booking', 'total_money') ?>
                                    <b>
                                        <span class="symbol_before"></span> 
                                ...
                                <p class="vat">(<?php echo Yii::t('tour_booking', 'include_vat') ?>)</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="submit-booking">
                        <div class="title-steps">
                            <h3><?php echo Yii::t('tour_booking', 'send_request_booking') ?></h3>
                            <div class="icon-steps">
                                <h4>3</h4>
                            </div>
                        </div>
                            ...
                            <div class="ProductAction clearfix">
                                <div class="ProductActionAdd"> 
                                    <a onclick="submit_booking()" href="javascript:void(0)" class="a-btn-2">
                                        <span class="a-btn-2-text"><?php echo Yii::t('tour_booking', 'btn_success'); ?></span> 
                                    </a>
                                </div>
                            </div>
