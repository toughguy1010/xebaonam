<div class="col-xs-4 theme-item">
    <div class="theme-box">
        <div class="theme-image">
            <img src="<?php echo ClaHost::getImageHost() . $theme['avatar_path'] . 's400_0/' . $theme['avatar_name']; ?>" alt="<?php echo $theme['theme_name']; ?>" />
        </div>
        ...
        <div class="theme-info">
            <div class="theme-info-box">
                ...
                <div class="theme-info-view">
                    ...
                    <a onclick="goog_report_conversion (<?php echo $theme['previewlink']; ?>)" href="<?php echo $theme['previewlink']; ?>" class="btn btn-sm btn-success" target="_blank" rel="nofollow">
