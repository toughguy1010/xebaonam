<div class="buycar registered-news clearfix">
    ...
    $form = $this->beginWidget('CActiveForm', array(
        ...
        'action' => Yii::app()->createUrl('car/service/registerTryDrive', array('id' => $form_id)),
            ...
            <div class=" w3-form-field width-r">
                <select id="CarForm_car_id" name="CarForm[car_id]" onchange="getImage()" class="form-control width-r">
                    ...
                    if (count($cars)) {
                        foreach ($cars as $car) {
                            ?>
                            <option <?php echo $model->car_id == $car['id'] ? 'selected' : '' ?> value="<?php echo $car['id'] ?>"><?php echo $car['name'] ?></option>
                            <?php
                        }
                    }
                    ?>
