...
<!--            <a href="<?php echo Yii::app()->createUrl('economy/productcategory'); ?>" class="btn btn-xs btn-success" style="margin-right: 20px;">
            ...
            <a href="<?php echo Yii::app()->createUrl('economy/productManager/create'); ?>" class="btn btn-xs btn-primary" style="margin-right: 20px;">
                <i class="icon-plus"></i>
                <?php echo Yii::t('product', 'product_create_new'); ?>
            </a>
            <a href="<?php echo Yii::app()->createUrl('economy/productManager/deleteall'); ?>" class="btn btn-xs btn-danger delAllinGrid" grid="product-grid">
    ...
    <div class="widget-body">
        <div class="widget-main">
            ...
            $this->widget('zii.widgets.grid.CGridView', array(
                'id' => 'product-grid',
                'dataProvider' => $model->searchByShop(),
                ...
                'columns' => array(
                    ...
                    'translate' => array(
                        ...
                        'value' => function($data) {
                    $this->widget('application.widgets.translate.translate', array('baseUrl' => '/economy/product/update', 'params' => array('id' => $data->id)));
                }
                    ),
                ),
            ));
