                        ...
                        <div class="check-orderpaper">
                            ...
                            <div class="col-xs-12">
                                    ...
                                    <div class="check-info-order">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                ...
                                                <?php
                                                $district = LibDistricts::getDistrictDetailFollowProvince($order['billing_city'], $order['billing_district']);
                                                echo $district['name'];
                                                ?>
                                                <?php
                                ...
                                <div class="time-order">
                                    <p><strong><?= Yii::t('shoppingcart', 'order-time'); ?>
                                            : </strong><?php echo date('d-m-Y H:i:s', $order['created_time']); ?> </p>
                                    <p><strong><?= Yii::t('shoppingcart', 'payment_method'); ?>
                                            : <?= $paymentmethod; ?> </strong></p>
                                    <p><strong><?= Yii::t('shoppingcart', 'payment_status'); ?>
                                            : <?= $order['payment_status'] == ActiveRecord::STATUS_ACTIVED ? 'Đã thanh toán' : 'Chưa thanh toán' ?> </strong>
                                    </p>
                                </div>
                            </div>
                                            ...
                                            <div class="statistic-order">
                                                ...
                                                if ($order['coupon_code']) {
                                                    ...
                                                    <p>
                                                        ...
                                                        <span class="price"><?= number_format($discount, 0, ',', '.') ?>
                                                            đ</span>
                                                    </p>
                                                    <?php
                                                }
                                                ...
                                                <?php if ($order['transport_freight']) { ?>
                                                    <p>
                                                        ...
                                                        <span class="price"><?= number_format($order['transport_freight'], 0, ',', '.') ?>
                                                            đ</span>
                                                    </p>
                                                <?php } ?>
                                                <p>
