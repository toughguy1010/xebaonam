                ...
                <div class="widget-box transparent invoice-box">
                    <div class="widget-header widget-header-large clearfix">
                        <div class="col-xs-8">
                            ...
                            <?php } ?>
                            <span style="font-size: 12;color: red;"><?php echo isset($error) ? $error : '' ?></span>
                            <br />
                            <span style="font-size: 10;color: blue;line-height: 10px">(Lưu ý: - Trạng thái đơn hàng chỉ "hoàn thành" khi vận chuyển và thanh toán thành công.
                        ...
                        <div class="col-xs-4">
                            <div class="row">
                                ...
                                <div class="widget-toolbar hidden-480">
                                    <a target="_blank" href="<?php echo Yii::app()->createUrl('/economy/order/printbill', array('id' => $model->order_id)) ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="widget-toolbar no-border invoice-info">
                                    ...
                                    if ($model->user_id != 0) {
                                        ?>
                                        <p>Khách hàng <strong><?php echo $model['billing_name'] ?></strong> đã đăng ký Bạn có muốn xem 
                                            <a style="color: red" href='<?php echo Yii::app()->createUrl("economy/order/userShoppingCart", array("id" => $model->user_id)) ?>'>
                                                lịch sử mua hàng
                                    ...
                                    <?php } else {
                                        ?>
                                        <p>Đơn hàng khách vãng lai - <a class="update_user" href='javascript:void(0)'>Liên kết với User</a></p>
                                        <div class="update_user_form" style="display: none">
                                            ...
                                            <?php echo CHtml::submitButton(Yii::t('common', 'update'), array('class' => 'btn btn-sm btn-primary', 'style' => 'margin-left:20px;')); ?>
                                            <br/>
                                            <span style="font-size: 12;color: red;">(Lưu ý: Nếu đã cập nhập bạn sẽ không thể sủa lại)</span>
                                            <?php $this->endWidget(); ?>
                                        </div>
                                        <script>
                                ...
                                <div class="col-sm-5 pull-right">
                                    ...
                                    <h4 class="pull-right">
                                        <?php if (isset($model['bonus_point_used']) && $model['bonus_point_used'] != 0) { ?>
                                            ...
                                            <span class="red"><?php echo Product::getPriceText(array('price' => $model['bonus_point_used'])); ?></span><br/>
                                        <?php } ?>
                                        <?php echo Yii::t('common', 'total') ?> :
                                        <span class="red"><?php echo Product::getPriceText(array('price' => $model['order_total'])); ?></span><br/>
                                    </h4>
                                </div>
                            </div>
