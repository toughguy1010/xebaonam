                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-hd">
                        ...
                        <div class="ctn-form-hd">
                            <h2 style="text-transform: uppercase"><?= Yii::t('translate', 'translation_bill') ?></h2>
                            <form>
                                ...
                                <div class="form-item-hd width-50 ">
                                    <label><?= $model->getAttributeLabel('tell') ?></label>
                                ...
                                <div class="form-item-hd">
                                    <label><?= Yii::t('translate', 'payment_method') ?>: </label>
                                    <p> <?php echo TranslateOrder::getPaymentMethod()[$model['payment_method']]; ?></p>
                                </div>
                                <div class="form-item-hd">
                                    <label><?= Yii::t('shoppingcart', 'payment_status') ?>: </label>
                                    <p> <?php echo TranslateOrder::getPaymentStatus()[$model['payment_status']]; ?></p>
                                </div>
