...
class EconomyAttributeHelper extends CComponent {
    ...
    public function attRenderHtmlAll($attribute_set_id, $product_info = null) {
        ...
        $dataReader = Yii::app()->db->createCommand()
                ...
                ->where('attribute_set_id=:attribute_set_id AND site_id=:site_id AND is_change_price=0', array(':attribute_set_id' => $attribute_set_id, ':site_id' => Yii::app()->siteinfo['site_id']))
    ...
    public function attRenderInputHtml($attribute, $htmlOptions = array(), $data = array()) {
        ...
        switch ($attribute['frontend_input']) {
            ...
            case 'textarea':
                ...
                break;
            case 'select':
                $htmlOptions = array_merge($htmlOptions, array('empty' => '-- Hãy chọn--', 'class' => 'span12 col-sm-4'));
